 ...
 * @since 5.0.0
 */
class AddressAutocomplete extends FeaturesAbstract implements RunsOnPluginActivationInterface {
	...
	public function output_admin_setting( PageAbstract $checkout_admin_page ) {
		...
		$checkout_admin_page->output_checkbox_row(
			...
			cfw__( 'Address Autocomplete', 'checkout-wc' ),
			cfw__( 'Enable address autocomplete.', 'checkout-wc' ),
