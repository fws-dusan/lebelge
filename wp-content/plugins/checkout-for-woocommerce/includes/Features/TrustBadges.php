 ...
 * @since 5.0.0
 */
class TrustBadges extends FeaturesAbstract implements RunsOnPluginActivationInterface {
	...
	public function output_trust_badges() {
		...
		<div id="cfw_trust_badges" class="cfw-module">
			...
			foreach ( $trust_badge_items as $badge ) :
				$image = wp_get_attachment_image( $badge['badge_attachment_id'], 'cfw_trust_badge_thumb' );
				?>
