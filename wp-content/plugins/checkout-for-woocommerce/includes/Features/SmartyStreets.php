...
class SmartyStreets extends FeaturesAbstract implements RunsOnPluginActivationInterface {
				...
				<div class="row">
					<div class="cfw-smartystreets-option-wrap col-5 cfw-selected-smartystreets-address">
						...
						<p class="cfw-smartystreets-button-wrap">
							<?php cfw_continue_to_shipping_button( __( 'Use This Address', 'checkout-wc' ), array( 'cfw-smartystreets-button', 'cfw-smartystreets-user-address-button', 'cfw-primary-btn' ) ); ?>
							<?php cfw_continue_to_payment_button( __( 'Use This Address', 'checkout-wc' ), array( 'cfw-smartystreets-button', 'cfw-smartystreets-user-address-button', 'cfw-primary-btn' ) ); ?>
						</p>
					</div>
					...
					<div class="cfw-smartystreets-option-wrap col-5 offset-2">
						...
						<p class="cfw-smartystreets-button-wrap">
							<?php cfw_continue_to_shipping_button( __( 'Use This Address', 'checkout-wc' ), array( 'cfw-smartystreets-button', 'cfw-smartystreets-suggested-address-button', 'cfw-primary-btn' ) ); ?>
							<?php cfw_continue_to_payment_button( __( 'Use This Address', 'checkout-wc' ), array( 'cfw-smartystreets-button', 'cfw-smartystreets-suggested-address-button', 'cfw-primary-btn' ) ); ?>
						</p>
					</div>
				</div>
			</div>
