...
class StatCollection extends SingletonAbstract implements RunsOnPluginActivationInterface, RunsOnPluginDeactivationInterface {
	 ...
	 * @return bool
	 */
	public function send_checkin( $override = false, $ignore_last_checkin = false ): bool {
	 ...
	 * @return bool
	 */
	function filter_dev_and_staging_domains( bool $track, string $home_url ): bool {
	...
	function run_on_plugin_deactivation() {
