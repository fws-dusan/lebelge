...
class ThemeHighCheckoutFieldEditor extends CompatibilityAbstract {
	...
	public function run() {
		...
		$instance = $this->get_hook_instance_object( 'woocommerce_billing_fields', 'billing_fields', $hp_billing_fields );
	 ...
	 */
	function admin_integration_settings( PageAbstract $integrations ) {
