...
class Square extends CompatibilityAbstract {
	...
	function payment_request_buttons() {
		$instance = $this->get_hook_instance_object( 'woocommerce_before_checkout_form', 'render_button', 15 );
	...
	function render_error_receiver_stub() {
		?>
