...
abstract class PageAbstract {
	 ...
	 */
	public function output_radio_group_row( string $setting, string $label, $default_value, array $options, array $descriptions, bool $enabled = true, string $notice = null, bool $show_overridden_notice = false ) {
	 ...
	 * @param string $overridden_notice
	 */
	public function output_toggle_checkbox( string $setting, string $label, string $description, bool $enabled = true, $show_overridden_notice = false, string $overridden_notice = '' ) {
		$settings   = SettingsManager::instance();
		$field_name = $settings->get_field_name( $setting );
		$value      = $settings->get_setting( $setting );
		?>
		<div class="postbox cfw-toggle-container">
			<div class="inside">
				<input <?php echo ! $enabled ? 'disabled' : ''; ?> type="hidden" name="<?php echo esc_attr( $field_name ); ?>" value="no" />
				<input <?php echo ! $enabled ? 'disabled' : ''; ?> type="checkbox" class="cfw-toggle-checkbox cfw-toggle-checkbox-<?php echo $setting; ?>" name="<?php echo esc_attr( $field_name ); ?>" id="<?php echo esc_attr( $field_name ); ?>" value="yes" <?php echo 'yes' === $value ? 'checked' : ''; ?> />

				<label class="cfw-toggle-checkbox-label cfw-toggle-checkbox-label-<?php echo $setting; ?>" for="<?php echo esc_attr( $field_name ); ?>">
					<?php echo $label; ?>
				</label>

				<label class="cfw-toggle-checkbox-text-label" for="<?php echo esc_attr( $field_name ); ?>"><?php echo $label; ?></label>
