		...
		<table class="form-table">
			<tbody>
				...
				$this->output_radio_group_row(
					'cart_item_link',
					cfw__( 'Cart Item Label', 'checkout-wc' ),
					'disabled',
					array(
						'disabled' => cfw__( 'Text (Recommended)', 'checkout-wc' ),
						'enabled'  => cfw__( 'Link', 'checkout-wc' ),
					),
					array(
						cfw__( 'Text: Do not link cart items to single product page. (Recommended)', 'checkout-wc' ),
						cfw__( 'Link: Link each cart item to product page.', 'checkout-wc' ),
					)
				);
