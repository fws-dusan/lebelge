...
* Added: Compatibility with 'WooCommerce file approval' plugin (fix/84)
* Added: Compatibility with 'Xendit' payment gateway. (fix/60)
* Updated: CMB2 plugin dependency updated. (fix/88)
* Improved: Order details component: Download products now showing the download name instead of product name. (fix/63)
