...
class xlwcty_Admin {
	...
	public function xlwcty_admin_page_settings_render() {
		$xlwcty_faq = array(
			__( 'I was unable to set up Thank You Page?', 'thank-you-page-for-woocommerce-nextmove' )                                        => __( 'Kindly visit our <a href="https://xlplugins.com/docs/nextmove-woocommerce-thank-you-page/getting-started/">documentation</a> to know more about how to setup thank you pages. ', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'Thank You page is not coming on frontend?', 'thank-you-page-for-woocommerce-nextmove' )                                     => __( 'Visit this step-by-step <a href="https://xlplugins.com/docs/nextmove-woocommerce-thank-you-page/troubleshooting-guides/thank-you-page-didnt-show/">documentation guide</a> to uncover the reasons for why Thank You Page may not be showing up.. ', 'thank-you-page-for-woocommerce-nextmove' ),
	...
	public function xlwcty_enqueue_admin_assets() {
		if ( XLWCTY_Common::is_load_admin_assets( 'all' ) ) {
			...
			wp_localize_script( 'xlwcty_admin-js', 'xlwcty_id', array( filter_input( INPUT_GET, 'id' ) ) );
	...
	public function xlwcty_plugin_row_actions( $links, $file ) {
		if ( $file == XLWCTY_PLUGIN_BASENAME ) {
			$links[] = '<a href="' . add_query_arg( array(
					...
					'utm_term'     => 'Docs',
				), 'https://xlplugins.com/docs/nextmove-woocommerce-thank-you-page/' ) . '">' . esc_html__( 'Docs', 'thank-you-page-for-woocommerce-nextmove' ) . '</a>';
