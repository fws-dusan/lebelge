...
class WSAL_NP_Plugin {
	...
	private function send_suspicious_activity( $not_info, $ip, $site_id, $alert_code, $username ) {
		...
		$replace = array( $title, $blogname, $username, $user_role, $date, $alert_code, $this->wsal->notifications_util->get_alert_severity( $alert_code ), $message, $metadata, $hyperlinks, $ip, $alert->object, $alert->event_type );
