...
class MonsterInsights_eCommerce {
	...
	public function init() {
		...
		if ( ! defined( 'MONSTERINSIGHTS_VERSION' ) || ! defined( 'MONSTERINSIGHTS_PRO_VERSION' ) || version_compare( MONSTERINSIGHTS_VERSION, '7.0', '<' ) ) {
	...
	public function requires_monsterinsights() {
		?>
		<div class="error">
			<p><?php echo esc_html__( 'Please install MonsterInsights Pro version 7.4 or newer to use the MonsterInsights eCommerce addon.', 'monsterinsights-ecommerce' ); ?></p>
		</div>
		<?php
	}
