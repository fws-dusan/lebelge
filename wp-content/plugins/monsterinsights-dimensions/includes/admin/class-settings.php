...
class MonsterInsights_Admin_Custom_Dimensions_Settings {
	...
	public function __construct() {
		...
		register_deactivation_hook( 'all-in-one-seo-pack/all_in_one_seo_pack.php', array( $this, 'aioseo_deactivate' ) );
		register_deactivation_hook( 'all-in-one-seo-pack-pro/all_in_one_seo_pack.php', array( $this, 'aioseo_deactivate' ) );
