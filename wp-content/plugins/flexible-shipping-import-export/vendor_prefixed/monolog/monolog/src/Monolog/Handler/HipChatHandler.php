 ...
 */
class HipChatHandler extends \FlexibleShippingImportExportVendor\Monolog\Handler\SocketHandler
{
    /**
     * Use API version 1
     */
     ...
     */
    public function __construct($token, $room, $name = 'Monolog', $notify = \false, $level = \FlexibleShippingImportExportVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $format = 'text', $host = 'api.hipchat.com', $version = self::API_V1)
    {
    ...
    protected function getAlertColor($level)
    {
        switch (\true) {
            ...
            case $level >= \FlexibleShippingImportExportVendor\Monolog\Logger::INFO:
                return 'green';
            case $level == \FlexibleShippingImportExportVendor\Monolog\Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
