...
use FlexibleShippingImportExportVendor\Monolog\Handler\AbstractHandler;
/**
...
class ErrorHandler
{
    ...
    public static function register(\Psr\Log\LoggerInterface $logger, $errorLevelMap = array(), $exceptionLevel = null, $fatalLevel = null)
    {
        ...
        \class_exists('FlexibleShippingImportExportVendor\\Psr\\Log\\LogLevel', \true);
    ...
    {
        $this->logger->log($this->uncaughtExceptionLevel === null ? \Psr\Log\LogLevel::ERROR : $this->uncaughtExceptionLevel, \sprintf('Uncaught Exception %s: "%s" at %s line %s', \FlexibleShippingImportExportVendor\Monolog\Utils::getClass($e), $e->getMessage(), $e->getFile(), $e->getLine()), array('exception' => $e));
    ...
    public function handleFatalError()
    {
        ...
        if ($lastError && \in_array($lastError['type'], self::$fatalErrors, \true)) {
            ...
            if ($this->logger instanceof \FlexibleShippingImportExportVendor\Monolog\Logger) {
                foreach ($this->logger->getHandlers() as $handler) {
                    if ($handler instanceof \FlexibleShippingImportExportVendor\Monolog\Handler\AbstractHandler) {
                        $handler->close();
                    }
                }
            }
