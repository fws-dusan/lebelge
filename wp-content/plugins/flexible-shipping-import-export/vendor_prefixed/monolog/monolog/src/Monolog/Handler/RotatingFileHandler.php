 ...
 */
class RotatingFileHandler extends \FlexibleShippingImportExportVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \FlexibleShippingImportExportVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \FlexibleShippingImportExportVendor\Monolog\Utils::canonicalizePath($filename);
