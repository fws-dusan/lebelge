 ...
 */
class FirePHPHandler extends \FlexibleShippingImportExportVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \FlexibleShippingImportExportVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
