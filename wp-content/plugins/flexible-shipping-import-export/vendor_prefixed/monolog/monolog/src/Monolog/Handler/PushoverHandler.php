 ...
 */
class PushoverHandler extends \FlexibleShippingImportExportVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \FlexibleShippingImportExportVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \FlexibleShippingImportExportVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \FlexibleShippingImportExportVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \FlexibleShippingImportExportVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \FlexibleShippingImportExportVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
