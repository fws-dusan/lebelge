 ...
 */
class BufferHandler extends \FlexibleShippingImportExportVendor\Monolog\Handler\AbstractHandler
{
    protected $handler;
     ...
     */
    public function __construct(\FlexibleShippingImportExportVendor\Monolog\Handler\HandlerInterface $handler, $bufferLimit = 0, $level = \FlexibleShippingImportExportVendor\Monolog\Logger::DEBUG, $bubble = \true, $flushOnOverflow = \false)
    {
