 ...
 */
class GroupHandler extends \FlexibleShippingImportExportVendor\Monolog\Handler\AbstractHandler
{
    protected $handlers;
    /**
    ...
    public function __construct(array $handlers, $bubble = \true)
    {
        foreach ($handlers as $handler) {
            if (!$handler instanceof \FlexibleShippingImportExportVendor\Monolog\Handler\HandlerInterface) {
