 ...
 */
class SlackbotHandler extends \FlexibleShippingImportExportVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \FlexibleShippingImportExportVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
