...
?>">
		<div class="body">
			...
			<div class="panel active" data-panel-id="reasons">
				<h4><strong><?php 
\_e('If you have a moment, please let us know why you are deactivating the plugin (anonymous feedback):', 'flexible-shipping-import-export');
?></strong></h4>
...
?></span>
					...
					<li class="reason has-input">
						<label>
							...
							<span><?php 
\_e('I have found a better plugin', 'flexible-shipping-import-export');
?></span>
						</label>
...
\_e('Please let us know how we can improve our plugin', 'flexible-shipping-import-export');
?>">
						</div>
					</li>
				</ul>
