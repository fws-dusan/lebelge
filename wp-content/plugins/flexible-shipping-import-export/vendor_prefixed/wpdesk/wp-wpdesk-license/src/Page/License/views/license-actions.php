...
<form method="POST">
    <table class="wpdesk_helper_key_table">
        <tr>
            <td><?php 
\_e('Key:', 'flexible-shipping-import-export');
?></td>
...
?> /></td>
        ...
        <tr>
            <td><?php 
\_e('Email:', 'flexible-shipping-import-export');
?></td>
...
if ($activation_status == 'Deactivated') {
    ...
    \_e('Activate', 'flexible-shipping-import-export');
    ?></button>
				<?php 
} else {
    ?>
                    <button class="wpdesk_helper_button button"><?php 
    \_e('Deactivate', 'flexible-shipping-import-export');
    ?></button>
				<?php 
}
?>
