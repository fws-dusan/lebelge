...
namespace FlexibleShippingImportExportVendor\WPDesk\Helper;

use Psr\Log\LoggerInterface;
use FlexibleShippingImportExportVendor\WPDesk\Helper\Debug\LibraryDebug;
use FlexibleShippingImportExportVendor\WPDesk\Helper\Integration\LicenseIntegration;
use FlexibleShippingImportExportVendor\WPDesk\Helper\Integration\LogsIntegration;
use FlexibleShippingImportExportVendor\WPDesk\Helper\Integration\SettingsIntegration;
use FlexibleShippingImportExportVendor\WPDesk\Helper\Integration\TrackerIntegration;
use FlexibleShippingImportExportVendor\WPDesk\Helper\Logs\LibraryInfoProcessor;
use FlexibleShippingImportExportVendor\WPDesk\Helper\Page\LibraryDebugPage;
 ...
 */
class PrefixedHelperAsLibrary implements \FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        $helper_info = new \FlexibleShippingImportExportVendor\WPDesk\Helper\HelperRemoveInfo();
    ...
    private function initialize()
    {
        ...
        $subscription_integration = new \FlexibleShippingImportExportVendor\WPDesk\Helper\Integration\LicenseIntegration();
        $subscription_integration->hooks();
        $settingsPage = new \FlexibleShippingImportExportVendor\WPDesk\Helper\Page\SettingsPage();
        $settings_integration = new \FlexibleShippingImportExportVendor\WPDesk\Helper\Integration\SettingsIntegration($settingsPage);
        $tracker_integration = new \FlexibleShippingImportExportVendor\WPDesk\Helper\Integration\TrackerIntegration($settingsPage);
        $logger_integration = new \FlexibleShippingImportExportVendor\WPDesk\Helper\Integration\LogsIntegration($settingsPage);
        ...
        (new \FlexibleShippingImportExportVendor\WPDesk\Helper\UpgradeSoonNotice())->show_info_about_upgrade_if_old_env();
        $this->clean_wpdesk_menu();
        $library_debug_info = new \FlexibleShippingImportExportVendor\WPDesk\Helper\Debug\LibraryDebug();
        (new \FlexibleShippingImportExportVendor\WPDesk\Helper\Page\LibraryDebugPage($library_debug_info))->hooks();
        self::$logger->pushProcessor(new \FlexibleShippingImportExportVendor\WPDesk\Helper\Logs\LibraryInfoProcessor($library_debug_info));
