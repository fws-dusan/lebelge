...
use FlexibleShippingImportExportVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \FlexibleShippingImportExportVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \FlexibleShippingImportExportVendor\WPDesk\License\Page\LicensePage($plugin_registry);
