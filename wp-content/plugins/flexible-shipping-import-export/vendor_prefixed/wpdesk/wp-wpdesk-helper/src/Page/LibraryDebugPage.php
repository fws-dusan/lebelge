 ...
 */
class LibraryDebugPage implements \FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function hooks()
    {
        \add_action('admin_menu', function () {
            ...
            \add_submenu_page($parent_slug, \__('Library report', 'flexible-shipping-import-export'), \__('Library report', 'flexible-shipping-import-export'), 'manage_options', 'wpdesk-helper-library-report', function () {
