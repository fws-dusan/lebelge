 ...
 */
class WPDesk_Plugin_Info implements \FlexibleShippingImportExportVendor\WPDesk_Translatable, \FlexibleShippingImportExportVendor\WPDesk_Buildable, \FlexibleShippingImportExportVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
