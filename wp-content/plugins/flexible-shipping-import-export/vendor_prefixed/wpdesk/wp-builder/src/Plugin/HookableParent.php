...
trait HookableParent
{
     ...
     */
    public function add_hookable(\FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\Hookable $hookable_object)
    {
        if ($hookable_object instanceof \FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant) {
    ...
    protected function hooks_on_hookable_objects()
    {
        ...
        foreach ($this->hookable_objects as $hookable_object) {
            if ($hookable_object instanceof \FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\Conditional) {
