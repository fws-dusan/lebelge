 ...
 */
class InfoActivationBuilder extends \FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
