 ...
 */
class ChainResolver implements \FlexibleShippingImportExportVendor\WPDesk\View\Resolver\Resolver
{
    /** @var Resolver[] */
    private $resolvers;
    /**
    ...
    public function resolve($name, \FlexibleShippingImportExportVendor\WPDesk\View\Renderer\Renderer $renderer = null)
    {
        foreach ($this->resolvers as $resolver) {
            ...
            } catch (\FlexibleShippingImportExportVendor\WPDesk\View\Resolver\Exception\CanNotResolve $e) {
                // not interested
            }
        }
