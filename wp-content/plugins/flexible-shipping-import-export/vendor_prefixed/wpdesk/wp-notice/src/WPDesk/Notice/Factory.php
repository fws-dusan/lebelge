...
class Factory
{
    ...
    {
        return new \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice($noticeContent, $noticeType, $isDismissible, $priority);
    }
    /**
    ...
    {
        return new \FlexibleShippingImportExportVendor\WPDesk\Notice\PermanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
