...
class WPDesk_Basic_Requirement_Checker_Factory
{
    ...
    {
        return new \FlexibleShippingImportExportVendor\WPDesk_Basic_Requirement_Checker($plugin_file, $plugin_name, $text_domain, null, null);
    }
    /**
    ...
    {
        $requirements_checker = new \FlexibleShippingImportExportVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable($plugin_file, $plugin_name, $text_domain, $requirements['php'], $requirements['wp']);
