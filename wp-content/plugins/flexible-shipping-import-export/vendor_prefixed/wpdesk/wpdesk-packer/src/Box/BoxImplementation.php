...
namespace FlexibleShippingImportExportVendor\WPDesk\Packer\Box;

use FlexibleShippingImportExportVendor\WPDesk\Packer\Box;
use FlexibleShippingImportExportVendor\WPDesk\Packer\Item\ItemImplementation;
class BoxImplementation extends \FlexibleShippingImportExportVendor\WPDesk\Packer\Item\ItemImplementation implements \FlexibleShippingImportExportVendor\WPDesk\Packer\Box
{
    /** @var float|null */
    private $max_weight;
    /** @var string */
