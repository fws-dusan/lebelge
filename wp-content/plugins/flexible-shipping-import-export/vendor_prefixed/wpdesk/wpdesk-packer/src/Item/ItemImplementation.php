...
namespace FlexibleShippingImportExportVendor\WPDesk\Packer\Item;

use FlexibleShippingImportExportVendor\WPDesk\Packer\Item;
class ItemImplementation implements \FlexibleShippingImportExportVendor\WPDesk\Packer\Item
{
    /** @var float */
