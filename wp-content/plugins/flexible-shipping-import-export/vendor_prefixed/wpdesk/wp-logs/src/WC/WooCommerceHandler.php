 ...
 */
class WooCommerceHandler extends \FlexibleShippingImportExportVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \FlexibleShippingImportExportVendor\Monolog\Logger::getLevelName($level);
    }
