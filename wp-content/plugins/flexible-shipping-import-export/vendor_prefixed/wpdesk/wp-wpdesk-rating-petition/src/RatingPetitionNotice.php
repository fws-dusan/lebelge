 ...
 */
namespace FlexibleShippingImportExportVendor\WPDesk\RepositoryRating;
 ...
 */
class RatingPetitionNotice implements \FlexibleShippingImportExportVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
     ...
     */
    public function __construct(\FlexibleShippingImportExportVendor\WPDesk\RepositoryRating\TimeWatcher $method_watcher, $namespace, $plugin_name, $rate_url = '')
    {
    ...
    {
        new \FlexibleShippingImportExportVendor\WPDesk\Notice\PermanentDismissibleNotice($this->get_notice_content(), $notice_name, \FlexibleShippingImportExportVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO);
    }
    /**
     * Get notice content.
     *
    ...
    private function get_notice_content()
    {
        ...
        $content = \sprintf(\__('Awesome, you\'ve been using %s for more than 2 weeks. Could you please do me a BIG favor and give it a 5-star rating on WordPress? ~ Peter', 'flexible-shipping-import-export'), $this->plugin_name);
        $content .= '<br/>';
