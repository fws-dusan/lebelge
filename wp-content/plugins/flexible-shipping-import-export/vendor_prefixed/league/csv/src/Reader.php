...
use FlexibleShippingImportExportVendor\League\Csv\Polyfill\EmptyEscapeParser;
use SplFileObject;
use TypeError;
 ...
 */
class Reader extends \FlexibleShippingImportExportVendor\League\Csv\AbstractCsv implements \Countable, \IteratorAggregate, \JsonSerializable
{
    /**
     * header offset.
     *
    ...
    protected function setHeader(int $offset) : array
    {
        ...
        if (\false === $header || [] === $header || [null] === $header) {
            throw new \FlexibleShippingImportExportVendor\League\Csv\SyntaxError(\sprintf('The header record does not exist or is empty at offset: `%s`', $offset));
        }
        if (0 === $offset) {
    ...
    protected function getDocument() : \Iterator
    {
        if (70400 > \PHP_VERSION_ID && '' === $this->escape) {
            ...
            return \FlexibleShippingImportExportVendor\League\Csv\Polyfill\EmptyEscapeParser::parse($this->document);
        }
    ...
    public function __call($method, array $arguments)
    {
        ...
        if (isset($whitelisted[$method])) {
            return (new \FlexibleShippingImportExportVendor\League\Csv\ResultSet($this->getRecords(), $this->getHeader()))->{$method}(...$arguments);
        }
    ...
    public function getRecords(array $header = []) : \Iterator
    {
        ...
        if ($this->is_empty_records_included) {
            ...
            return $this->combineHeader(new \FlexibleShippingImportExportVendor\League\Csv\MapIterator($records, $normalized_empty_records), $header);
        }
    ...
    protected function computeHeader(array $header)
    {
        ...
        throw new \FlexibleShippingImportExportVendor\League\Csv\SyntaxError('The header record must be empty or a flat array with unique string values');
    }
    /**
    ...
    protected function combineHeader(\Iterator $iterator, array $header) : \Iterator
    {
        ...
        return new \FlexibleShippingImportExportVendor\League\Csv\MapIterator($iterator, $mapper);
    }
    /**
    ...
    public function setHeaderOffset($offset) : self
    {
        ...
        if (null !== $offset && 0 > $offset) {
            throw new \FlexibleShippingImportExportVendor\League\Csv\InvalidArgument(__METHOD__ . '() expects 1 Argument to be greater or equal to 0');
        }
