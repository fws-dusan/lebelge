...
class EncloseField extends \php_user_filter
{
     ...
     */
    public static function addTo(\FlexibleShippingImportExportVendor\League\Csv\Writer $csv, string $sequence) : \FlexibleShippingImportExportVendor\League\Csv\Writer
    {
        self::register();
    ...
    {
        return isset($this->params['sequence']) && $this->isValidSequence($this->params['sequence']);
    }
    /**
     * {@inheritdoc}
     */
