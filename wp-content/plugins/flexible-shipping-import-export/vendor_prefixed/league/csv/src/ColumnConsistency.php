...
class ColumnConsistency
{
    ...
    {
        if ($columns_count < -1) {
            throw new \FlexibleShippingImportExportVendor\League\Csv\Exception(\sprintf('%s() expects the column count to be greater or equal to -1 %s given', __METHOD__, $columns_count));
        }
