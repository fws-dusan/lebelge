...
class CharsetConverter extends \php_user_filter
{
     ...
     */
    public static function addTo(\FlexibleShippingImportExportVendor\League\Csv\AbstractCsv $csv, string $input_encoding, string $output_encoding) : \FlexibleShippingImportExportVendor\League\Csv\AbstractCsv
    {
        self::register();
    ...
    public function convert($records)
    {
        ...
        return new \FlexibleShippingImportExportVendor\League\Csv\MapIterator($records, $this);
    }
    /**
