 ...
 */
abstract class AbstractCsv implements \FlexibleShippingImportExportVendor\League\Csv\ByteSequence
{
    /**
    ...
    {
        throw new \FlexibleShippingImportExportVendor\League\Csv\Exception(\sprintf('An object of class %s cannot be cloned', static::class));
    }
    /**
    ...
    {
        return new static(new \FlexibleShippingImportExportVendor\League\Csv\Stream($stream));
    }
    /**
    ...
    {
        return new static(\FlexibleShippingImportExportVendor\League\Csv\Stream::createFromString($content));
    }
    /**
    ...
    {
        return new static(\FlexibleShippingImportExportVendor\League\Csv\Stream::createFromPath($path, $open_mode, $context));
    }
    /**
    ...
    {
        return $this->document instanceof \FlexibleShippingImportExportVendor\League\Csv\Stream;
    }
    /**
    ...
    {
        if ($length < 1) {
            throw new \FlexibleShippingImportExportVendor\League\Csv\InvalidArgument(\sprintf('%s() expects the length to be a positive integer %d given', __METHOD__, $length));
        }
    ...
    protected function sendHeaders(string $filename)
    {
        if (\strlen($filename) != \strcspn($filename, '\\/')) {
            throw new \FlexibleShippingImportExportVendor\League\Csv\InvalidArgument('The filename cannot contain the "/" and "\\" characters.');
        }
    ...
    public function setDelimiter(string $delimiter) : self
    {
        ...
        throw new \FlexibleShippingImportExportVendor\League\Csv\InvalidArgument(\sprintf('%s() expects delimiter to be a single character %s given', __METHOD__, $delimiter));
    }
    /**
    ...
    public function setEnclosure(string $enclosure) : self
    {
        ...
        throw new \FlexibleShippingImportExportVendor\League\Csv\InvalidArgument(\sprintf('%s() expects enclosure to be a single character %s given', __METHOD__, $enclosure));
    }
    /**
    ...
    public function setEscape(string $escape) : self
    {
        ...
        throw new \FlexibleShippingImportExportVendor\League\Csv\InvalidArgument(\sprintf('%s() expects escape to be a single character or the empty string %s given', __METHOD__, $escape));
    }
    /**
    ...
    {
        if (!$this->document instanceof \FlexibleShippingImportExportVendor\League\Csv\Stream) {
            throw new \FlexibleShippingImportExportVendor\League\Csv\UnavailableFeature('The stream filter API can not be used with a ' . \get_class($this->document) . ' instance.');
        }
