 ...
 */
class Writer extends \FlexibleShippingImportExportVendor\League\Csv\AbstractCsv
{
    /**
    ...
    public function insertOne(array $record) : int
    {
        ...
        throw \FlexibleShippingImportExportVendor\League\Csv\CannotInsertRecord::triggerOnInsertion($record);
    }
    /**
    ...
    protected function validateRecord(array $record)
    {
        foreach ($this->validators as $name => $validator) {
            if (\true !== $validator($record)) {
                throw \FlexibleShippingImportExportVendor\League\Csv\CannotInsertRecord::triggerOnValidation($name, $record);
            }
        }
    }
    /**
    ...
    public function setFlushThreshold($threshold) : self
    {
        ...
        if (null !== $threshold && 1 > $threshold) {
            throw new \FlexibleShippingImportExportVendor\League\Csv\InvalidArgument(__METHOD__ . '() expects 1 Argument to be null or a valid integer greater or equal to 1');
        }
