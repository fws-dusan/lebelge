...
class RFC4180Field extends \php_user_filter
{
     ...
     */
    public static function addTo(\FlexibleShippingImportExportVendor\League\Csv\AbstractCsv $csv, string $whitespace_replace = '') : \FlexibleShippingImportExportVendor\League\Csv\AbstractCsv
    {
        self::register();
        $params = ['enclosure' => $csv->getEnclosure(), 'escape' => $csv->getEscape(), 'mode' => $csv->getStreamFilterMode()];
        if ($csv instanceof \FlexibleShippingImportExportVendor\League\Csv\Writer && '' != $whitespace_replace) {
     ...
     */
    public static function addFormatterTo(\FlexibleShippingImportExportVendor\League\Csv\Writer $csv, string $whitespace_replace) : \FlexibleShippingImportExportVendor\League\Csv\Writer
    {
