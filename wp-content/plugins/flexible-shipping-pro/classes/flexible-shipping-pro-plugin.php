...
class WPDesk_Flexible_Shipping_Pro_Plugin extends AbstractPlugin implements HookableCollection {
	...
	public function hooks() {
		...
		add_action( 'flexible-shipping/core/initialized', array( $this, 'initialize_flexible_shipping_external_access' ) );
	 ...
	 */
	public function initialize_flexible_shipping_external_access( ExternalPluginAccess $external_plugin_access ) {
	...
	public function links_filter( $links ) {
		$docs_link    = get_locale() === 'pl_PL' ? 'https://www.wpdesk.pl/docs/flexible-shipping-pro-woocommerce-docs/' : 'https://docs.flexibleshipping.com/collection/20-fs-table-rate/?utm_source=fs-pro&utm_medium=link&utm_campaign=plugin-list-docs';
		$support_link = get_locale() === 'pl_PL' ? 'https://www.wpdesk.pl/support/' : 'https://flexibleshipping.com/support/?utm_source=fs-pro&utm_medium=link&utm_campaign=plugin-list-support';
