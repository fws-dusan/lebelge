...
use FSProVendor\WPDesk\PluginBuilder\Storage\Exception\ClassNotExists;
 ...
 */
class HelperRemover implements \FSProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    private function remove_helper_updates()
    {
        ...
        \add_action('plugins_loaded', function () {
            \remove_action('plugins_loaded', [$this->get_helper_instance(), 'init_helper_plugins'], \FSProVendor\WPDesk\Helper\Integration\LicenseIntegration::PRIORITY_HELPER_UPDATE);
        });
    }
    /**
     * @return void
    ...
    private function get_helper_instance()
    {
        ...
        } catch (\FSProVendor\WPDesk\PluginBuilder\Storage\Exception\ClassNotExists $e) {
            return null;
        }
    }
}
