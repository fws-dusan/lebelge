...
?>">
			<?php 
\_e('Set image', 'flexible-shipping-pro');
?>
        </a>
...
?>" href="#">
			<?php 
\_e('Remove image', 'flexible-shipping-pro');
?>
        </a>
    </p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: <?php 
\_e('Select or Upload Media', 'flexible-shipping-pro');
?>,
				button: {
					text: <?php 
\_e('Use this media', 'flexible-shipping-pro');
?>
				},
				library: {
					type: ['image']
