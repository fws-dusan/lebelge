...
trait LocalCodeceptionTrait
{
    ...
    {
        try {
            $wpdesk_configuration = \FSProVendor\Symfony\Component\Yaml\Yaml::parseFile(\getcwd() . '/tests/codeception/wpdesk.yml');
        } catch (\FSProVendor\Symfony\Component\Yaml\Exception\ParseException $e) {
            $wpdesk_configuration = array();
        }
        return \FSProVendor\WPDesk\Composer\Codeception\Commands\Configuration::createFromEnvAndConfiguration($wpdesk_configuration);
    }
    /**
     * @param OutputInterface $output
     * @param Configuration   $configuration
     */
    private function prepareWpConfig(\FSProVendor\Symfony\Component\Console\Output\OutputInterface $output, \FSProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param Configuration   $configuration
     */
    private function activatePlugins(\FSProVendor\Symfony\Component\Console\Output\OutputInterface $output, \FSProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     */
    private function executeWpCliAndOutput($command, \FSProVendor\Symfony\Component\Console\Output\OutputInterface $output, $apache_document_root)
    {
     ...
     * @param Configuration   $configuration
     */
    private function installPlugin($plugin_slug, \FSProVendor\Symfony\Component\Console\Output\OutputInterface $output, \FSProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @return string
     */
    private function prepareTargetDir($plugin_slug, \FSProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param OutputInterface $output
     */
    private function prepareCommonWpWcConfiguration(\FSProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, \FSProVendor\Symfony\Component\Console\Output\OutputInterface $output)
    {
