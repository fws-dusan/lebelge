...
if ( !class_exists('Wcap_Product_Report_List' ) ) {
    ...
    class Wcap_Product_Report_List{
        ...
        public static function wcap_display_product_report_list( ){
			...
			<?php esc_html_e( 'The list below shows the products which have been abandoned along with the number of times they have been abandoned and recovered.', 'woocommerce-ac' );
			?>
			</p>
            <div class="wrap">
