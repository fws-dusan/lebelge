...
class WCAP_Manual_Email {
    ...
    public static function wcap_display_manual_email_template (){
        ...
        $query = "SELECT template_name, id, subject, body, is_wc_template, wc_email_header, coupon_code, generate_unique_coupon_code, discount, discount_type, discount_shipping, discount_expiry, individual_use  FROM `" . WCAP_EMAIL_TEMPLATE_TABLE . "` ORDER BY day_or_hour asc , frequency asc";
