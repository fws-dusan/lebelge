...
if ( !class_exists('Wcap_Common' ) ) {
    ...
    class Wcap_Common {
        ...
        private static function wcap_get_email_templates_data() {
            ...
            $wcap_email_templates_query   = "SELECT id, is_active, is_wc_template,frequency, day_or_hour, subject, match_rules, rules FROM `" . WCAP_EMAIL_TEMPLATE_TABLE . "`";
            ...
            foreach ( $wcap_email_templates_results as $wcap_email_templates_results_key => $wcap_email_templates_results_value ) {
                ...
                $wcap_templates_data [ 'template_id_' . $wcap_email_templates_results_value->id ] ['match_rules'] = $wcap_email_templates_results_value->match_rules;
                ...
                $wcap_templates_data [ 'template_id_' . $wcap_email_templates_results_value->id ] ['rules'] = $rules;
        ...
        private static function wcap_get_plugin_settings() {
            ...
            $wcap_settings [ 'wcap_atc_enable_modal' ]                     = wcap_get_atc_active_status();
            $wcap_settings [ 'wcap_atc_mandatory_email' ]                  = wcap_get_atc_email_mandatory_status();
        ...
        public static function wcap_replace_email_body_merge_code( $body_email_preview ) {
            ...
            $merge_tag_values['cart.unsubscribe']    = get_option('siteurl');
        ...
        static function wcap_updated_recovered_cart( $cart_id, $order_id, $wcap_check_email_sent_to_cart, $order ) {
            ...
            if( $recovered_status == 0 ) {
                ...
                if ( $wcap_check_email_sent_to_cart > 0 ) {
                    ...
                    $get_old_cart_id = $wpdb->get_var( $wpdb->prepare( $check_emails, $wcap_check_email_sent_to_cart ) );
                }
