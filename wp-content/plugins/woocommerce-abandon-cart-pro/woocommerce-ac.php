...
$edd_updater = new EDD_AC_WOO_Plugin_Updater( EDD_SL_STORE_URL_AC_WOO, __FILE__, array(
        'version'   => '8.13.0',                     // current version number
...
if ( ! class_exists( 'Woocommerce_Abandon_Cart' ) ) {
    ...
    class Woocommerce_Abandon_Cart {
        ...
        public function __construct() {
            ...
            // Load the Files.
			add_action( 'plugins_loaded', array( &$this, 'wcap_load_files' ), 5 );

			// Initialize settings.
			register_activation_hook( __FILE__, array( 'Wcap_Activate_Plugin', 'wcap_activate' ) );
            register_deactivation_hook( __FILE__, array( &$this, 'wcap_deactivate' ) );
			
            add_action( 'plugins_loaded', array( &$this, 'wcap_load_hooks' ), 6 );
        }
        ...
        public static function wcap_define_constants_for_table_and_other (){
            ...
            if ( !defined( 'WCAP_PLUGIN_VERSION' ) ) {
                define('WCAP_PLUGIN_VERSION', "8.13.0" );
            }
            ...
            if ( !defined( 'WCAP_ATC_RULES_TABLE' ) ) {
                define('WCAP_ATC_RULES_TABLE', $wpdb->prefix . "ac_atc_rules" );
            }

            if ( !defined( 'WCAP_AC_STATS' ) ) {
                define('WCAP_AC_STATS', $wpdb->prefix . "ac_statistics" );
            }
        }
        ...
        public static function wcap_load_files() {
            ...
            require_once( 'includes/admin/class-wcap-print-and-csv.php' );
            ...
            require_once( 'includes/wcap-email-functions.php' );
            ...
            if ( true === $is_admin ) {
                ...
                require_once( "includes/admin/class-wcap-abandoned-cart-details.php" );
            ...
            if ( isset( $wcap_auto_cron ) && $wcap_auto_cron != false && '' != $wcap_auto_cron ) {
                require_once( "cron/class-wcap-send-email-using-cron.php" );
            ...
            require_once( 'includes/class-wcap-email_verification.php' );
        ...
        public static function wcap_load_admin_side_files(){
            ...
            require_once( "includes/admin/class-wcap-abandoned-cart-list.php" );
            require_once( "includes/admin/class-wcap-email-template-list.php" );
            require_once( "includes/admin/class-wcap-atc-templates-list.php" );
        ...
        public static function wcap_load_support_class_files(){
            ...
            require_once( "includes/classes/class-wcap-send-manual-email.php" );
            ...
            require_once( 'includes/classes/class-wcap-atc-templates-table.php' );
        }
         ...
         * @since 5.0
         */
        static function wcap_load_hooks (){
