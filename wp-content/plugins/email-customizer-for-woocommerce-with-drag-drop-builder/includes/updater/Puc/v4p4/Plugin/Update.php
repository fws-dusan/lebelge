<?php
if ( !class_exists('WooMail_Puc_v4p4_Plugin_Update', false) ):
	 ...
	 * @access public
	 */
	class WooMail_Puc_v4p4_Plugin_Update extends WooMail_Puc_v4p4_Update {
		public $id = 0;
		public $homepage;
		...
		public static function fromJson($json){
			...
			$pluginInfo = WooMail_Puc_v4p4_Plugin_Info::fromJson($json);
			if ( $pluginInfo !== null ) {
		 ...
		 *
		 * @param WooMail_Puc_v4p4_Plugin_Info $info
		 * @return WooMail_Puc_v4p4_Plugin_Update
		 */
		 ...
		 *
		 * @param StdClass|WooMail_Puc_v4p4_Plugin_Info|WooMail_Puc_v4p4_Plugin_Update $object The source object.
		 * @return WooMail_Puc_v4p4_Plugin_Update The new copy.
		 */
