        ...
        <tr class="<?php echo esc_attr(apply_filters('woocommerce_order_item_class', 'order_item', $item, $order)); ?>">
            <?php if ($args['rtl'] == '0'): ?>
                <td class="td col-product"
                    style="text-align: left;vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;<?php echo $row_index == sizeof($items) ? 'border:1px solid transparent;border-bottom: 1px solid #ccc;;' : 'border:1px solid transparent;' ?>padding-top: 15px;padding-bottom: 15px;"><?php
                    ...
                    if ($args['show_product_link']){
                      ...
                      echo apply_filters('woocommerce_order_item_name', '<div class="product-name">'.$item->get_name().'</div>', $item, false);
                    }
                ...
                <td class="td col-quantity"
                    style="text-align: center;  vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;<?php echo $row_index == sizeof($items) ? 'border:1px solid transparent;border-bottom: 1px solid #ccc;;' : 'border:1px solid transparent;' ?>  padding-top: 15px;  padding-bottom: 15px;">
                    <?php echo apply_filters('woocommerce_email_order_item_quantity', $item->get_quantity(), $item); ?>
                </td>
                <td class="td col-price"
                    style="text-align: right;  vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;<?php echo $row_index == sizeof($items) ? 'border:1px solid transparent;border-bottom: 1px solid #ccc;;' : 'border:1px solid transparent;' ?>padding-top: 15px;padding-bottom: 15px;">
