        ...
        <tr class="<?php echo esc_attr(apply_filters('woocommerce_order_item_class', 'order_item', $item, $order)); ?>">
            <?php if ($args['rtl'] == '1'): ?>
                ...
                <td class="td col-product" width="60%"
                    style="text-align: left;  vertical-align: middle;  padding-left: 15px;font-family: inherit;font-size: 13px;word-wrap: break-word;border-bottom: 1px solid #ccc;padding-top: 15px;padding-bottom: 15px;"><?php
                ...
                <td class="td col-price" width="15%"
                    style="text-align: right;vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;border-bottom: 1px solid #ccc;padding-top: 15px;padding-right: 15px;padding-bottom: 15px;">
