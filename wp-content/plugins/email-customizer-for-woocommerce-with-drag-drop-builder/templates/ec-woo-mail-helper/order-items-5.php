...
$path_order_item = EC_WOO_BUILDER_PATH . '/templates/ec-woo-mail-helper/order-items-rows-5.php';
...
<div style="color:#000;margin-bottom: 20px;font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;">
    <table class="woo-order-id-4" width="100%" cellspacing="0" cellpadding="0" border="0"
           style="width:100%;background-color:#fff;  border: 2px solid #eeece7;" bgcolor="#ffffff">
        <tr>
            ...
            <td width="50%" style="text-align:right;padding:10px;color: #8e8e8e;font-size: 10px;font-family: Helvetica, sans-serif, 'Open Sans';">
                <?php printf(
                    '<time datetime="%s" class="order-time" >%s</time>',
                    date_i18n('c', strtotime(EC_Helper::get_order_date($order))),
                    date_i18n(wc_date_format(), strtotime(EC_Helper::get_order_date($order)))
                ); ?>
            </td>
        </tr>
    </table>
...
<table class="woo-items-list-5"
       cellspacing="0"
       cellpadding="<?php echo $ec_woo_settings_border_padding; ?>"
       style="width: 100% !important;font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;    border: 1px solid #eaeaea;"
       border="0">
    <thead>
    <tr>
        <?php if ($ec_woo_settings_rtl == '0'): ?>
            <th scope="col" class="col-product" width="50%"
                style="text-align:left;border: 1px solid #f3f3f3;color: #606060;font-size: 12px;background-color: #f3f3f3;    padding: 15px;"><?php _e('Product', 'woocommerce'); ?></th>
            <th scope="col" class="col-quantity" width="20%"
                style="text-align:center;border: 1px solid #f3f3f3;color: #606060;font-size: 12px;background-color: #f3f3f3;    padding: 15px;"><?php _e('Quantity', 'woocommerce'); ?></th>
            <th scope="col" class="col-price" width="30%"
                style="text-align:right;border: 1px solid #f3f3f3;color: #606060;font-size: 12px;background-color: #f3f3f3;    padding: 15px;"><?php _e('Price', 'woocommerce'); ?></th>
        <?php endif; ?>
        <?php if ($ec_woo_settings_rtl == '1'): ?>
            <th scope="col" class="col-product" width="50%"
                style="text-align:right;border: 1px solid #f3f3f3;color: #606060;font-size: 12px;background-color: #f3f3f3;    padding: 15px;"><?php _e('Product', 'woocommerce'); ?></th>
            <th scope="col" class="col-quantity" width="20%"
                style="text-align:center;border: 1px solid #f3f3f3;color: #606060;font-size: 12px;background-color: #f3f3f3;    padding: 15px;"><?php _e('Quantity', 'woocommerce'); ?></th>
            <th scope="col" class="col-price" width="30%"
                style="text-align:right;border: 1px solid #f3f3f3;color: #606060;font-size: 12px;background-color: #f3f3f3;    padding: 15px;"><?php _e('Price', 'woocommerce'); ?></th>
...
<table class="woo-items-list-5-total" width="100%" bg-color="#f9f9f9" cellpadding="0" border="0" cellspacing="0"
       style="border: 1px solid #eaeaea;width:100%;background-color:#f9f9f9;">
    <?php
        ...
        foreach ($total_values as $item) {
            ...
            <tr>
              ...
              <?php echo $index == 1 ? 'padding-top:20px;' : '';
                    ...
                    <td class="col-total-value" width="35%" style="text-align: right; color: #262626; padding-right: 20px; font-family: Helvetica, sans-serif;font-size: 14px;font-weight: normal;
            <?php echo $index == 1 ? 'padding-top:30px;' : '';
                    echo $index == sizeof($total_values) ? 'font-weight: bold;padding-bottom:20px;' : 'font-weight: 300;'; ?>">
                        <?php echo $item['value']; ?>
                    </td>
                <?php endif; ?>
