...
foreach ($items as $item_id => $item) :
    ...
    if (apply_filters('woocommerce_order_item_visible', true, $item)) {
		...
		<tr class="<?php echo esc_attr(apply_filters('woocommerce_order_item_class', 'order_item', $item, $order)); ?>">
			<?php if ($args['rtl']=='0'): ?>
        <td class="td col-product" style="text-align: left;vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;border-bottom: 1px solid #ccc;  padding-top: 15px;padding-bottom: 15px;"><?php
        ...
        echo '</td>';
        echo '</tr></table>'; ?></td>
  			<td class="td col-quantity" style="text-align: center;vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;border-bottom: 1px solid #ccc;padding-top: 15px;padding-bottom: 15px;">
          <?php echo apply_filters('woocommerce_email_order_item_quantity', $item->get_quantity(), $item); ?>
        </td>
  			<td class="td col-price" style="text-align: right;  vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;  border-bottom: 1px solid #ccc;  padding-top: 15px;  padding-bottom: 15px;">
