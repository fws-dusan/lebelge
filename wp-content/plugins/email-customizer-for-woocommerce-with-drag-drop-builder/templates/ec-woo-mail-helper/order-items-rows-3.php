        ...
        <tr class="<?php echo esc_attr(apply_filters('woocommerce_order_item_class', 'order_item', $item, $order)); ?>">
            <?php if ($args['rtl'] == '0'): ?>
                <td class="td col-product" width="60%"
                    style="text-align: left;vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;  border:1px solid transparent;border-bottom: 1px solid #ccc;padding-top: 15px;padding-bottom: 15px;"><?php
                ...
                <td class="td col-quantity" width="25%"
                    style="text-align: center;vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;  border:1px solid transparent;border-bottom: 1px solid #ccc;padding-top: 15px;padding-bottom: 15px;">
                ...
                <td class="td col-price" width="15%"
                    style="text-align: right;vertical-align: middle;font-family: inherit;font-size: 13px;word-wrap: break-word;border:1px solid transparent;border-bottom: 1px solid #ccc;padding-top: 15px;padding-bottom: 15px;">
