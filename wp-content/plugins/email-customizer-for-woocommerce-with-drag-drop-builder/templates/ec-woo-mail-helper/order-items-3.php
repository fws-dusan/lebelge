...
$path_order_item = EC_WOO_BUILDER_PATH . '/templates/ec-woo-mail-helper/order-items-rows-3.php';
    ...
    <table class="woo-items-list-3"
        ...
        if (isset($total_values)) {
            ...
            foreach ($total_values as $item) {
                ...
                <tr>
                    <?php if ($ec_woo_settings_rtl == '0'): ?>
                        <th class="col-total-label" scope="row" width="75%" colspan="2"
                            style="text-align: right;    color: #606060;font-size: 13px;  font-family: sans-serif;  font-weight: bold;letter-spacing: 0.5px;<?php echo $index == 1 ? 'padding-top:30px;' : ''; ?>  ">
                            <?php echo $item['label']; ?>
                        </th>
                        <td class="col-total-value" width="25%"
                            style="text-align: right; color: #262626;  font-family: Helvetica, sans-serif;font-size: 14px;font-weight: normal;<?php echo $index == 1 ? 'padding-top:30px;' : '';
                    ...
                    <?php if ($ec_woo_settings_rtl == '1'): ?>
                        ...
                        <th class="col-total-label" scope="row" width="55%" colspan="2"
                            style="width:55%;text-align: left;    color: #606060;font-size: 13px;  font-family: sans-serif;  font-weight: bold;letter-spacing: 0.5px;<?php echo $index == 1 ? 'padding-top:30px;' : ''; ?>  ">
                            <?php echo $item['label']; ?>
                        </th>
                        <td class="col-total-value" width="40%"
                            style="width:40%;text-align: right; color: #262626;  font-family: Helvetica, sans-serif;font-size: 14px;font-weight: normal;<?php echo $index == 1 ? 'padding-top:30px;' : '';
                            echo $index == sizeof($total_values) ? 'font-weight: bold' : 'font-weight: 300;'; ?>">
                            <?php echo $item['value']; ?>
                        </td>
                    <?php endif; ?>
