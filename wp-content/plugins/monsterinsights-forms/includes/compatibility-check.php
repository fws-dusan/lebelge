...
class MonsterInsights_Forms_Compatibility_Check {
	...
	public function display_php_notice() {
		...
		<div class="error">
			<p>
				<?php echo sprintf(
					esc_html__( 'Sorry, but your version of PHP does not meet MonsterInsights Forms Addon\'s required version of %1$s%2$s%3$s to run properly. The plugin has not been activated. %4$sClick here to return to the Dashboard%5$s.', 'monsterinsights-forms' ),
					'<strong>',
	...
	public function display_wp_notice() {
		...
		<div class="error">
			<p>
				...
				echo sprintf(
					esc_html__( 'Sorry, but your version of WordPress does not meet MonsterInsights Form Addon\'s required version of %1$s%2$s%3$s to run properly. The plugin has not been activated. %4$sClick here to return to the Dashboard%5$s.', 'monsterinsights-forms' ),
					'<strong>',
