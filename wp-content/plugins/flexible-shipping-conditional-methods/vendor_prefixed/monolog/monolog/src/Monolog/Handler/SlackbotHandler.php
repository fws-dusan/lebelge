 ...
 */
class SlackbotHandler extends \FSConditionalMethodsVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \FSConditionalMethodsVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
