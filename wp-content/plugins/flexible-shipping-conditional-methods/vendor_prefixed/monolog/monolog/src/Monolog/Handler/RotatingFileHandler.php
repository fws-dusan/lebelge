 ...
 */
class RotatingFileHandler extends \FSConditionalMethodsVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \FSConditionalMethodsVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \FSConditionalMethodsVendor\Monolog\Utils::canonicalizePath($filename);
