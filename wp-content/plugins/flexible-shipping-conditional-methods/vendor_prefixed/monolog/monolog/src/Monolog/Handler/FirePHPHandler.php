...
use FSConditionalMethodsVendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \FSConditionalMethodsVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \FSConditionalMethodsVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
