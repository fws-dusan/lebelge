 ...
 */
class BrowserConsoleHandler extends \FSConditionalMethodsVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \FSConditionalMethodsVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
