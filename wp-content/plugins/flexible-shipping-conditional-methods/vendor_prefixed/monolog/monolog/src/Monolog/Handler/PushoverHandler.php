 ...
 */
class PushoverHandler extends \FSConditionalMethodsVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \FSConditionalMethodsVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \FSConditionalMethodsVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \FSConditionalMethodsVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \FSConditionalMethodsVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \FSConditionalMethodsVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
