...
namespace FSConditionalMethodsVendor\WPDesk\Persistence;
 ...
 */
interface DeferredPersistentContainer extends \FSConditionalMethodsVendor\WPDesk\Persistence\PersistentContainer
{
    /**
     * Save changed data.
     *
