...
use FSConditionalMethodsVendor\WPDesk\Persistence\DeferredPersistentContainer;
use FSConditionalMethodsVendor\WPDesk\Persistence\ElementNotExistsException;
use FSConditionalMethodsVendor\WPDesk\Persistence\FallbackFromGetTrait;
 ...
 */
class DelayPersistentContainer implements \FSConditionalMethodsVendor\WPDesk\Persistence\DeferredPersistentContainer
{
     ...
     */
    protected $changed = [];
    public function __construct(\FSConditionalMethodsVendor\WPDesk\Persistence\PersistentContainer $container)
    {
