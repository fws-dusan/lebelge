...
namespace FSConditionalMethodsVendor\WPDesk\Notice;

use FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
 ...
 */
class AjaxHandler implements \FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            \update_option(\FSConditionalMethodsVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName, \FSConditionalMethodsVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
