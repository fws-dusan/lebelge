...
if (!\class_exists('FSConditionalMethodsVendor\\WPDesk_Basic_Requirement_Checker')) {
...
if (!\class_exists('FSConditionalMethodsVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker_With_Update_Disable extends \FSConditionalMethodsVendor\WPDesk_Basic_Requirement_Checker
    {
        /**
