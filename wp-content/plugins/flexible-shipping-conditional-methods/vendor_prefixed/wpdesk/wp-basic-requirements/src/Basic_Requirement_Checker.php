...
if (!\interface_exists('FSConditionalMethodsVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('FSConditionalMethodsVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \FSConditionalMethodsVendor\WPDesk_Requirement_Checker
    {
