...
class WPDesk_Helper_List_Table extends \WP_List_Table
{
    ...
    {
        echo \wpautop(\__('No WP Desk plugins found.', 'flexible-shipping-conditional-methods'));
    }
    ...
    {
        $columns = ['product_name' => \__('Plugin', 'flexible-shipping-conditional-methods'), 'product_status' => \__('Subscription Status', 'flexible-shipping-conditional-methods'), 'product_license' => \__('Subscription Data', 'flexible-shipping-conditional-methods')];
        return $columns;
    }
    ...
    {
        $status = \__('Deactivated', 'flexible-shipping-conditional-methods');
        if ($item['activation_status'] == 'Activated') {
            $status = \__('Activated', 'flexible-shipping-conditional-methods');
        }
        return $status;
    }
