...
<form method="POST">
    <table class="wpdesk_helper_key_table">
        <tr>
            <td><?php 
\_e('Key:', 'flexible-shipping-conditional-methods');
?></td>
...
?> /></td>
        ...
        <tr>
            <td><?php 
\_e('Email:', 'flexible-shipping-conditional-methods');
?></td>
...
if ($activation_status == 'Deactivated') {
    ...
    \_e('Activate', 'flexible-shipping-conditional-methods');
    ?></button>
				<?php 
} else {
    ?>
                    <button class="wpdesk_helper_button button"><?php 
    \_e('Deactivate', 'flexible-shipping-conditional-methods');
    ?></button>
				<?php 
}
?>
