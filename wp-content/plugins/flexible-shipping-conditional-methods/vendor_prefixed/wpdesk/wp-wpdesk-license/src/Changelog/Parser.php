...
namespace FSConditionalMethodsVendor\WPDesk\License\Changelog;

use ArrayObject;
use FSConditionalMethodsVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \FSConditionalMethodsVendor\WPDesk\License\Changelog\Parser\Line($line);
