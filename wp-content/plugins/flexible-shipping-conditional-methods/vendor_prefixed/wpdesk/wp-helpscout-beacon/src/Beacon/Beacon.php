...
class Beacon
{
     ...
     */
    public function __construct($beacon_id, \FSConditionalMethodsVendor\WPDesk\Beacon\BeaconShouldShowStrategy $strategy, $assets_url, $beacon_search_elements_class = 'hs-beacon-search', $beacon_image_content = '')
    {
