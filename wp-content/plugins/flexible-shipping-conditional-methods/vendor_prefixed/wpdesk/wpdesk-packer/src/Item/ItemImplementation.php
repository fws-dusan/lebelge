...
namespace FSConditionalMethodsVendor\WPDesk\Packer\Item;

use FSConditionalMethodsVendor\WPDesk\Packer\Item;
class ItemImplementation implements \FSConditionalMethodsVendor\WPDesk\Packer\Item
{
    /** @var float */
