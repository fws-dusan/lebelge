...
use FSConditionalMethodsVendor\WPDesk\Packer\Box\BoxImplementation;
use FSConditionalMethodsVendor\WPDesk\Packer\Packer;
/**
...
abstract class BoxFactory
{
     ...
     */
    public function append_all_boxes(\FSConditionalMethodsVendor\WPDesk\Packer\Packer $boxpack)
    {
     ...
     * @param string $key .
     */
    public function append_single_box(\FSConditionalMethodsVendor\WPDesk\Packer\Packer $boxpack, $key)
    {
     ...
     * @param array  $box .
     */
    protected function append_box(\FSConditionalMethodsVendor\WPDesk\Packer\Packer $boxpack, $key, $box)
    {
        $newbox = new \FSConditionalMethodsVendor\WPDesk\Packer\Box\BoxImplementation($box['length'], $box['width'], $box['height'], 0, $box['weight'], array('id' => $key, 'box' => $box));
