...
namespace FSConditionalMethodsVendor\WPDesk\Packer\Box;

use FSConditionalMethodsVendor\WPDesk\Packer\Box;
use FSConditionalMethodsVendor\WPDesk\Packer\Item\ItemImplementation;
class BoxImplementation extends \FSConditionalMethodsVendor\WPDesk\Packer\Item\ItemImplementation implements \FSConditionalMethodsVendor\WPDesk\Packer\Box
{
    /** @var float|null */
    private $max_weight;
    /** @var string */
