...
class ChainValidator implements \FSConditionalMethodsVendor\WPDesk\Forms\Validator
{
    /** @var Validator[] */
    private $validators;
    private $messages;
     ...
     * @return $this
     */
    public function attach(\FSConditionalMethodsVendor\WPDesk\Forms\Validator $validator)
    {
