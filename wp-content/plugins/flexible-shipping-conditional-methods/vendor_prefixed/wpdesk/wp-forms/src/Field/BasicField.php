...
use FSConditionalMethodsVendor\WPDesk\Forms\Sanitizer\NoSanitize;
use FSConditionalMethodsVendor\WPDesk\Forms\Serializer;
use FSConditionalMethodsVendor\WPDesk\Forms\Serializer\NoSerialize;
use FSConditionalMethodsVendor\WPDesk\Forms\Validator\ChainValidator;
use FSConditionalMethodsVendor\WPDesk\Forms\Validator\RequiredValidator;
/**
 ...
 */
abstract class BasicField implements \FSConditionalMethodsVendor\WPDesk\Forms\Field
{
    ...
    {
        $chain = new \FSConditionalMethodsVendor\WPDesk\Forms\Validator\ChainValidator();
        if ($this->is_required()) {
            $chain->attach(new \FSConditionalMethodsVendor\WPDesk\Forms\Validator\RequiredValidator());
        }
        return $chain;
    }
    ...
    {
        return new \FSConditionalMethodsVendor\WPDesk\Forms\Sanitizer\NoSanitize();
    }
    /**
     * @return Serializer
     */
    ...
    {
        if (isset($this->meta['serializer']) && $this->meta['serializer'] instanceof \FSConditionalMethodsVendor\WPDesk\Forms\Serializer) {
            return $this->meta['serializer'];
        }
        return new \FSConditionalMethodsVendor\WPDesk\Forms\Serializer\NoSerialize();
    }
    public function set_serializer(\FSConditionalMethodsVendor\WPDesk\Forms\Serializer $serializer)
    {
