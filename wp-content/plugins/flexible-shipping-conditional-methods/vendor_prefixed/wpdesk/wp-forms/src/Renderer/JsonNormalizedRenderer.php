...
namespace FSConditionalMethodsVendor\WPDesk\Forms\Renderer;

use FSConditionalMethodsVendor\WPDesk\Forms\FieldProvider;
use FSConditionalMethodsVendor\WPDesk\Forms\FieldRenderer;
/**
 * Can render form fields as JSON.
 *
 * @package WPDesk\Forms\Renderer
 */
class JsonNormalizedRenderer implements \FSConditionalMethodsVendor\WPDesk\Forms\FieldRenderer
{
    /**
     ...
     */
    public function render_fields(\FSConditionalMethodsVendor\WPDesk\Forms\FieldProvider $provider, array $fields_data, $name_prefix = '')
    {
        $rendered_fields = [];
