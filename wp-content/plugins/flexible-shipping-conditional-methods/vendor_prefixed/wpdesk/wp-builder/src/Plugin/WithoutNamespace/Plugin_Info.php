...
if (!\interface_exists('FSConditionalMethodsVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('FSConditionalMethodsVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('FSConditionalMethodsVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \FSConditionalMethodsVendor\WPDesk_Translatable, \FSConditionalMethodsVendor\WPDesk_Buildable, \FSConditionalMethodsVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
