...
trait HookableParent
{
     ...
     */
    public function add_hookable(\FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\Hookable $hookable_object)
    {
        if ($hookable_object instanceof \FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant) {
    ...
    protected function hooks_on_hookable_objects()
    {
        ...
        foreach ($this->hookable_objects as $hookable_object) {
            if ($hookable_object instanceof \FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\Conditional) {
