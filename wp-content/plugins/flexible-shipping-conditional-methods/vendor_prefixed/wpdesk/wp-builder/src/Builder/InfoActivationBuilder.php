...
namespace FSConditionalMethodsVendor\WPDesk\PluginBuilder\Builder;
...
use FSConditionalMethodsVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \FSConditionalMethodsVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\FSConditionalMethodsVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\FSConditionalMethodsVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
