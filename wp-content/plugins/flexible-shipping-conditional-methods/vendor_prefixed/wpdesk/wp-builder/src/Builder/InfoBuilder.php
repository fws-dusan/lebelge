 ...
 */
class InfoBuilder extends \FSConditionalMethodsVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\FSConditionalMethodsVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
