...
use FSConditionalMethodsVendor\Monolog\Handler\AbstractProcessingHandler;
use FSConditionalMethodsVendor\Monolog\Logger;
/**
 * Class WooCommerceFactory
 */
class WooCommerceHandler extends \FSConditionalMethodsVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \FSConditionalMethodsVendor\Monolog\Logger::getLevelName($level);
    }
