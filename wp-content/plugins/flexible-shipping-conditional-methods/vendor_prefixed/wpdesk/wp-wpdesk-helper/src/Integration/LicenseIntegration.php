...
use FSConditionalMethodsVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \FSConditionalMethodsVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \FSConditionalMethodsVendor\WPDesk\License\Page\LicensePage($plugin_registry);
