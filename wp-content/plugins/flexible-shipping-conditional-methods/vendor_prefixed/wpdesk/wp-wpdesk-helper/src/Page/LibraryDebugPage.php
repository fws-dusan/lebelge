...
namespace FSConditionalMethodsVendor\WPDesk\Helper\Page;
 ...
 */
class LibraryDebugPage implements \FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    const PRIOTITY_LONG_AFTER_ALL_IS_LOADED = 999;
    /** @var LibraryDebug */
    private $library_debug;
    public function __construct(\FSConditionalMethodsVendor\WPDesk\Helper\Debug\LibraryDebug $library_debug)
    {
    ...
    public function hooks()
    {
        \add_action('admin_menu', function () {
            ...
            \add_submenu_page($parent_slug, \__('Library report', 'flexible-shipping-conditional-methods'), \__('Library report', 'flexible-shipping-conditional-methods'), 'manage_options', 'wpdesk-helper-library-report', function () {
