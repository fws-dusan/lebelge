...
use FSConditionalMethodsVendor\WPDesk\PluginBuilder\Storage\Exception\ClassNotExists;
 ...
 */
class HelperRemover implements \FSConditionalMethodsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    private function remove_helper_updates()
    {
        ...
        \add_action('plugins_loaded', function () {
            \remove_action('plugins_loaded', [$this->get_helper_instance(), 'init_helper_plugins'], \FSConditionalMethodsVendor\WPDesk\Helper\Integration\LicenseIntegration::PRIORITY_HELPER_UPDATE);
        });
    }
    /**
     * @return void
    ...
    private function get_helper_instance()
    {
        ...
        } catch (\FSConditionalMethodsVendor\WPDesk\PluginBuilder\Storage\Exception\ClassNotExists $e) {
            return null;
        }
    }
}
