...
namespace UpsProVendor\GuzzleHttp\Psr7;
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Message::toString($message);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Utils::uriFor($uri);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Utils::streamFor($resource, $options);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Header::parse($header);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Header::normalize($header);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Utils::modifyRequest($request, $changes);
}
/**
...
{
    \UpsProVendor\GuzzleHttp\Psr7\Message::rewindBody($message);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Utils::tryFopen($filename, $mode);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Utils::copyToString($stream, $maxLen);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Utils::copyToStream($source, $dest, $maxLen);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Utils::hash($stream, $algo, $rawOutput);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Utils::readLine($stream, $maxLength);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Message::parseRequest($message);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Message::parseResponse($message);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Query::parse($str, $urlEncoding);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Query::build($params, $encoding);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\MimeType::fromFilename($filename);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\MimeType::fromExtension($extension);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Message::parseMessage($message);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Message::parseRequestUri($path, $headers);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Message::bodySummary($message, $truncateAt);
}
/**
...
{
    return \UpsProVendor\GuzzleHttp\Psr7\Utils::caselessRemove($keys, $data);
}
