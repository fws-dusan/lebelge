...
class UploadedFile implements \Psr\Http\Message\UploadedFileInterface
{
    ...
    private function setStreamOrFile($streamOrFile)
    {
        if (\is_string($streamOrFile)) {
            ...
            $this->stream = new \UpsProVendor\GuzzleHttp\Psr7\Stream($streamOrFile);
    ...
    private function setError($error)
    {
        ...
        if (\false === \in_array($error, \UpsProVendor\GuzzleHttp\Psr7\UploadedFile::$errors)) {
    ...
    public function getStream()
    {
        ...
        return new \UpsProVendor\GuzzleHttp\Psr7\LazyOpenStream($this->file, 'r+');
    }
    /**
     * {@inheritdoc}
     *
    ...
    public function moveTo($targetPath)
    {
        ...
        if ($this->file) {
            ...
            \UpsProVendor\GuzzleHttp\Psr7\Utils::copyToStream($this->getStream(), new \UpsProVendor\GuzzleHttp\Psr7\LazyOpenStream($targetPath, 'w'));
            $this->moved = \true;
        }
        if (\false === $this->moved) {
