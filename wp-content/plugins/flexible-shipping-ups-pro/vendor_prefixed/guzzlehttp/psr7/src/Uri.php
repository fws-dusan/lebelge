...
class Uri implements \Psr\Http\Message\UriInterface
{
    ...
    {
        if ($base !== null) {
            $uri = \UpsProVendor\GuzzleHttp\Psr7\UriResolver::resolve($base, $uri);
    ...
    {
        return \UpsProVendor\GuzzleHttp\Psr7\UriResolver::removeDotSegments($path);
    }
    /**
    ...
    public static function resolve(\Psr\Http\Message\UriInterface $base, $rel)
    {
        ...
        return \UpsProVendor\GuzzleHttp\Psr7\UriResolver::resolve($base, $rel);
    }
    /**
