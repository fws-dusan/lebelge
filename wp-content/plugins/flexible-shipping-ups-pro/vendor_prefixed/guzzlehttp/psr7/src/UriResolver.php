...
final class UriResolver
{
    ...
    public static function resolve(\Psr\Http\Message\UriInterface $base, \Psr\Http\Message\UriInterface $rel)
    {
        ...
        return new \UpsProVendor\GuzzleHttp\Psr7\Uri(\UpsProVendor\GuzzleHttp\Psr7\Uri::composeComponents($base->getScheme(), $targetAuthority, $targetPath, $targetQuery, $rel->getFragment()));
    }
    /**
    ...
    public static function relativize(\Psr\Http\Message\UriInterface $base, \Psr\Http\Message\UriInterface $target)
    {
        ...
        if (\UpsProVendor\GuzzleHttp\Psr7\Uri::isRelativePathReference($target)) {
