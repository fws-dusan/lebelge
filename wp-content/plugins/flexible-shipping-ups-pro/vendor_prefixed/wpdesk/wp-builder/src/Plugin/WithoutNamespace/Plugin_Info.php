...
if (!\interface_exists('UpsProVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('UpsProVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('UpsProVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \UpsProVendor\WPDesk_Translatable, \UpsProVendor\WPDesk_Buildable, \UpsProVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
