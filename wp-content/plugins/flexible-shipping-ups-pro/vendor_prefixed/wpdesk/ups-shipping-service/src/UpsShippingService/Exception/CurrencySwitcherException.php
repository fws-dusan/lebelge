 ...
 */
namespace UpsProVendor\WPDesk\UpsShippingService\Exception;
...
class CurrencySwitcherException extends \RuntimeException
{
    ...
    public function __construct()
    {
        ...
        $message = \sprintf(
            // Translators: link.
            \__('Multi currency is supported by Flexible Shipping UPS Pro version only! %1$sCheck out more: %2$s%3$s', 'flexible-shipping-ups-pro'),
