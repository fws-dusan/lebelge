 ...
 */
namespace UpsProVendor\WPDesk\WooCommerceShipping\CustomFields\ApiStatus;
 ...
 */
class FieldApiStatusAjax implements \UpsProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * Shipping service.
     *
     ...
     */
    public function __construct(\UpsProVendor\WPDesk\AbstractShipping\ShippingService $shipping_service, \UpsProVendor\WPDesk\AbstractShipping\Settings\SettingsValues $settings, \Psr\Log\LoggerInterface $logger)
    {
    ...
    public function handle_api_status_ajax_request($return = \false)
    {
        ...
        $json_response = array('connected' => \true, 'status' => \__('OK', 'flexible-shipping-ups-pro'), 'class_name' => 'wpdesk_wc_shipping_api_status_ok');
    ...
    {
        if ($this->shipping_service instanceof \UpsProVendor\WPDesk\AbstractShipping\ShippingServiceCapability\CanTestSettings) {
