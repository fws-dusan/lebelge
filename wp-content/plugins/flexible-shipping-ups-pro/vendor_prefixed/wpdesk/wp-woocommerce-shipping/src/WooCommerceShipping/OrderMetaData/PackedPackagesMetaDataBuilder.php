...
class PackedPackagesMetaDataBuilder
{
     ...
     */
    public function __construct(\UpsProVendor\WPDesk\AbstractShipping\Shipment\Shipment $shipment)
    {
    ...
    public function create_meta_data()
    {
        ...
        foreach ($this->shipment->packages as $package) {
            ...
            $packed_packages[] = ['package' => isset($package->description) ? $package->description : \__('Custom', 'flexible-shipping-ups-pro'), 'items' => $items];
        }
