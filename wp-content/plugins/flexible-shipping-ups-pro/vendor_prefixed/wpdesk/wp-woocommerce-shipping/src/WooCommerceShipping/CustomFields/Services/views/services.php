...
\esc_html_e('Code', 'flexible-shipping-ups-pro');
?></th>
				<th class="service_name"><?php 
\esc_html_e('Name', 'flexible-shipping-ups-pro');
?></th>
				<th class="select">
					<?php 
\esc_html_e('Enabled', 'flexible-shipping-ups-pro');
?>
				</th>
			</tr>
			</thead>
...
\esc_html_e('Drag and drop the services to control their display order. Confirm by clicking Save changes button below.', 'flexible-shipping-ups-pro');
?></span></th>
			</tr>
			</tfoot>
		</table>
