...
class EstimatedDeliveryMetaDataBuilder
{
     ...
     * @return array
     */
    public function append_delivery_dates_metadata_if_exists(array $meta_data, \UpsProVendor\WPDesk\AbstractShipping\Rate\SingleRate $rate)
    {
        ...
        $meta_data[\UpsProVendor\WPDesk\WooCommerceShipping\EstimatedDelivery\EstimatedDeliveryDatesDisplay::DELIVERY_DATES] = $this->shipping_method->get_delivery_dates_setting($this->shipping_method);
        return $meta_data;
    }
}
