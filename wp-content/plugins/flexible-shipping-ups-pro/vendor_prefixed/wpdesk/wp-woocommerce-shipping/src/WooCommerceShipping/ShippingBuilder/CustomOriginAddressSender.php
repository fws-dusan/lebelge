 ...
 * @package WPDesk\ShippingBuilder\Address
 */
class CustomOriginAddressSender implements \UpsProVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider
{
    /**
     * @var Address;
     */
    ...
    {
        $this->sender_address = new \UpsProVendor\WPDesk\AbstractShipping\Shipment\Address();
