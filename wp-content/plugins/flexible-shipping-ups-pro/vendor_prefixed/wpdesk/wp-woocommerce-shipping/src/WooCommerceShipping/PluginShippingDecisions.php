...
class PluginShippingDecisions
{
     ...
     *
     */
    public function __construct(\UpsProVendor\WPDesk\AbstractShipping\ShippingService $service, \Psr\Log\LoggerInterface $logger)
    {
     ...
     */
    public function set_field_api_status_ajax(\UpsProVendor\WPDesk\WooCommerceShipping\CustomFields\ApiStatus\FieldApiStatusAjax $field_api_status_ajax)
    {
