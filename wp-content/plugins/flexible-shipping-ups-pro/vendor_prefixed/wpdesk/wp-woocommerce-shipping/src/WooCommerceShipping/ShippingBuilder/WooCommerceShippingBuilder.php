 ...
 */
namespace UpsProVendor\WPDesk\WooCommerceShipping\ShippingBuilder;

use UpsProVendor\WPDesk\AbstractShipping\Rate\Money;
use UpsProVendor\WPDesk\AbstractShipping\Shipment\Client;
...
class WooCommerceShippingBuilder
{
     ...
     */
    public function set_sender_address(\UpsProVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider $sender_address)
    {
     ...
     */
    public function set_receiver_address(\UpsProVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider $receiver_address)
    {
    ...
    protected function get_woocommerce_dimension_unit()
    {
        switch ($this->dimension_unit) {
            case 'mm':
                return \UpsProVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_MM;
            case 'cm':
                return \UpsProVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_CM;
            case 'm':
                return \UpsProVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_M;
            case 'in':
                return \UpsProVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_IN;
        }
    ...
    protected function get_woocommerce_weight_unit()
    {
        switch ($this->weight_unit) {
            case 'g':
                return \UpsProVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_G;
            case 'kg':
                return \UpsProVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_KG;
            case 'lb':
                return \UpsProVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_LB;
        }
    ...
    {
        $item = new \UpsProVendor\WPDesk\AbstractShipping\Shipment\Item();
        ...
        $item->declared_value = new \UpsProVendor\WPDesk\AbstractShipping\Rate\Money();
    ...
    {
        $shipping_package = new \UpsProVendor\WPDesk\AbstractShipping\Shipment\Package();
        $package_weight = new \UpsProVendor\WPDesk\AbstractShipping\Shipment\Weight();
    ...
    {
        $shipment = new \UpsProVendor\WPDesk\AbstractShipping\Shipment\Shipment();
        $ship_from = new \UpsProVendor\WPDesk\AbstractShipping\Shipment\Client();
        $ship_from->address = $this->sender_address->get_address();
        $ship_to = new \UpsProVendor\WPDesk\AbstractShipping\Shipment\Client();
