 ...
 */
class CachedCollectionPointsProvider implements \UpsProVendor\WPDesk\AbstractShipping\CollectionPointCapability\CollectionPointsProvider
{
    /**
     ...
     * @param string                   $salt .
     */
    public function __construct(\UpsProVendor\WPDesk\AbstractShipping\CollectionPointCapability\CollectionPointsProvider $collection_points_provider, \UpsProVendor\WPDesk\Persistence\PersistentContainer $persistent_container, $salt)
    {
     ...
     * @return string
     */
    private function get_address_as_string(\UpsProVendor\WPDesk\AbstractShipping\Shipment\Address $address)
    {
