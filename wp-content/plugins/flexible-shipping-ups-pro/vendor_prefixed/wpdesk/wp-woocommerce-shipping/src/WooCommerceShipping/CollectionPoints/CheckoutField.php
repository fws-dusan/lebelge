...
abstract class CheckoutField
{
     ...
     */
    public function __construct(array $collection_points, $selected_collection_point, \UpsProVendor\WPDesk\View\Renderer\Renderer $renderer, $label, $unavailable_points_label, $description, $shipping_method_id)
    {
