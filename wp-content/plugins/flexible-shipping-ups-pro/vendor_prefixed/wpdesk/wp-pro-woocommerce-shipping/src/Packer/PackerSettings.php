...
class PackerSettings
{
    ...
    {
        return \UpsProVendor\WpDesk\WooCommerce\ShippingMethod\PackerBoxesFactory::create_packer_boxes_from_settings($settings->get_option(self::OPTION_SHIPPING_BOXES, '[]'), $default_boxes);
    }
    /**
     ...
     */
    public function add_packaging_fields(\UpsProVendor\WPDesk\AbstractShipping\Settings\SettingsDefinition $definition, $add_after = 'fallback')
    {
        $description = '';
        ...
        $definition = new \UpsProVendor\WPDesk\AbstractShipping\Settings\DefinitionModifier\SettingsDefinitionModifierAfter($definition, $add_after, self::OPTION_SHIPPING_BOXES, ['title' => \__('Shipping boxes', 'flexible-shipping-ups-pro'), 'type' => \UpsProVendor\WPDesk\WooCommerceShippingPro\CustomFields\ShippingBoxes::get_type_name(), 'class' => 'no-flat-rate', 'description' => $description, 'desc_tip' => \false]);
        $definition = new \UpsProVendor\WPDesk\AbstractShipping\Settings\DefinitionModifier\SettingsDefinitionModifierAfter($definition, $add_after, self::OPTION_PACKAGING_METHOD, ['title' => \__('Parcel Packing Method', 'flexible-shipping-ups-pro'), 'type' => 'select', 'options' => array(self::PACKING_METHOD_WEIGHT => \__('Pack into one box by weight', 'flexible-shipping-ups-pro'), self::PACKING_METHOD_BOX => \__('Pack into custom boxes', 'flexible-shipping-ups-pro'), self::PACKING_METHOD_SEPARATELY => \__('Pack items separately', 'flexible-shipping-ups-pro')), 'description' => \__('This option allows you to achieve more accurate Shipping Rates.', 'flexible-shipping-ups-pro'), 'desc_tip' => \true, 'default' => self::PACKING_METHOD_WEIGHT]);
        return $definition;
    }
}
