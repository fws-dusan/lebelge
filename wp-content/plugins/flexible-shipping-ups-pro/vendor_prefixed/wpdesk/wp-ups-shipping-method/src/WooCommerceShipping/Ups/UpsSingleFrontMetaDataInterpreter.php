...
use UpsProVendor\WPDesk\WooCommerceShipping\OrderMetaData\SingleFrontOrderMetaDataInterpreter;
/**
 * Can interpret UPS meta data from WooCommerce order shipping on admin and front.
 */
class UpsSingleFrontMetaDataInterpreter implements \UpsProVendor\WPDesk\WooCommerceShipping\OrderMetaData\SingleFrontOrderMetaDataInterpreter
{
    /**
     * Key.
     *
