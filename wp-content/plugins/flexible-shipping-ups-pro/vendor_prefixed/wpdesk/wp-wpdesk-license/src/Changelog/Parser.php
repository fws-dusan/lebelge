...
namespace UpsProVendor\WPDesk\License\Changelog;

use ArrayObject;
use UpsProVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \UpsProVendor\WPDesk\License\Changelog\Parser\Line($line);
