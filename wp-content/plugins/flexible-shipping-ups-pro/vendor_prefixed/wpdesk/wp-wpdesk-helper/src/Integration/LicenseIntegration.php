...
use UpsProVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \UpsProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \UpsProVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \UpsProVendor\WPDesk\License\Page\LicensePage($plugin_registry);
