...
namespace UpsProVendor\WPDesk\Helper\Page;
 ...
 */
class LibraryDebugPage implements \UpsProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    const PRIOTITY_LONG_AFTER_ALL_IS_LOADED = 999;
    /** @var LibraryDebug */
    private $library_debug;
    public function __construct(\UpsProVendor\WPDesk\Helper\Debug\LibraryDebug $library_debug)
    {
    ...
    public function hooks()
    {
        \add_action('admin_menu', function () {
            ...
            \add_submenu_page($parent_slug, \__('Library report', 'flexible-shipping-ups-pro'), \__('Library report', 'flexible-shipping-ups-pro'), 'manage_options', 'wpdesk-helper-library-report', function () {
