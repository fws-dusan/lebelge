 ...
 */
class SettingsPage implements \UpsProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        \add_submenu_page('wpdesk-helper', \__('Settings', 'flexible-shipping-ups-pro'), \__('Settings', 'flexible-shipping-ups-pro'), 'manage_options', 'wpdesk-helper-settings', function () {
    ...
    private function handle_render_wpdesk_helper_settings()
    {
        ...
        <div class="wrap">
            <h1><?php 
        \_e('WP Desk Helper Settings', 'flexible-shipping-ups-pro');
        ?></h1>
