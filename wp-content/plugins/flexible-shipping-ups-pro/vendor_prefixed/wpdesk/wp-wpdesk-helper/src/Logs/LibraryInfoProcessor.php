...
namespace UpsProVendor\WPDesk\Helper\Logs;

use UpsProVendor\Monolog\Processor\ProcessorInterface;
 ...
 */
class LibraryInfoProcessor implements \UpsProVendor\Monolog\Processor\ProcessorInterface
{
    /** @var LibraryDebug */
