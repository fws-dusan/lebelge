 ...
 */
namespace UpsProVendor\WPDesk\AbstractShipping\Settings\DefinitionModifier;
 ...
 */
class SettingsDefinitionModifierBefore extends \UpsProVendor\WPDesk\AbstractShipping\Settings\SettingsDefinition
{
    /**
     ...
     */
    public function __construct(\UpsProVendor\WPDesk\AbstractShipping\Settings\SettingsDefinition $decorated_settings_definition, $field_id_before, $new_field_id, array $new_field)
    {
    ...
    public function get_form_fields()
    {
        ...
        throw new \UpsProVendor\WPDesk\AbstractShipping\Exception\SettingsFieldNotExistsException(\sprintf('Field %1$s not found in settings!', $this->field_id_before));
    }
    /**
     * Validate settings.
     *
