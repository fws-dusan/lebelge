 ...
 */
namespace UpsProVendor\WPDesk\AbstractShipping\Rate;
 ...
 * @package WPDesk\AbstractShipping
 */
class ShipmentRatingImplementation implements \UpsProVendor\WPDesk\AbstractShipping\Rate\ShipmentRating
{
    /**
     * Rates.
     *
