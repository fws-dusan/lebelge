...
if (!\class_exists('UpsProVendor\\Basic_Requirement_Checker')) {
    require_once 'Basic_Requirement_Checker.php';
}
if (!\class_exists('UpsProVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
...
class WPDesk_Basic_Requirement_Checker_Factory
{
    ...
    {
        return new \UpsProVendor\WPDesk_Basic_Requirement_Checker($plugin_file, $plugin_name, $text_domain, null, null);
    }
    /**
    ...
    {
        $requirements_checker = new \UpsProVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable($plugin_file, $plugin_name, $text_domain, $requirements['php'], $requirements['wp']);
