 ...
 */
class SettingsBox extends \UpsProVendor\WpDesk\WooCommerce\ShippingMethod\AbstractBox implements \JsonSerializable
{
    ...
    {
        $box = new \UpsProVendor\WpDesk\WooCommerce\ShippingMethod\SettingsBox();
