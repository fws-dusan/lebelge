 ...
 */
class BuiltInBox extends \UpsProVendor\WpDesk\WooCommerce\ShippingMethod\AbstractBox implements \JsonSerializable
{
    /**
     ...
     * @return BuiltInBox
     */
    public static function create_from_code_and_packer_box($code, \UpsProVendor\WPDesk\Packer\Box $packer_box)
    {
        $box = new self();
        $box->set_code($code);
