...
final class PackedBox
{
     ...
     * @param Item[] $items
     */
    public function __construct(\UpsProVendor\WPDesk\Packer\Box $box, array $items)
    {
        $this->box = $box;
     ...
     * @return bool
     */
    private function can_be_packed(\UpsProVendor\WPDesk\Packer\Item $item, $current_weight, $current_volume)
    {
        // Check dimensions
