...
namespace UpsProVendor\WPDesk\Packer\Box;

use UpsProVendor\WPDesk\Packer\Box;
use UpsProVendor\WPDesk\Packer\Item\ItemImplementation;
class BoxImplementation extends \UpsProVendor\WPDesk\Packer\Item\ItemImplementation implements \UpsProVendor\WPDesk\Packer\Box
{
    /** @var float|null */
    private $max_weight;
    /** @var string */
