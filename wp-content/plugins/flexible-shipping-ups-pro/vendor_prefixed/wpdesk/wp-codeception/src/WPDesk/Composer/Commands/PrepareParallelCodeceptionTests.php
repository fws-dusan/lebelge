 ...
 */
class PrepareParallelCodeceptionTests extends \UpsProVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    ...
    {
        parent::configure();
        $this->setName('prepare-parallel-codeception-tests')->setDescription('Prepare parallel codeception tests.')->setDefinition(array(new \UpsProVendor\Symfony\Component\Console\Input\InputArgument(self::NUMBER_OF_JOBS, \UpsProVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Number of jobs.', '4')));
    }
    /**
     * Execute command.
     *
