...
trait LocalCodeceptionTrait
{
    ...
    {
        try {
            $wpdesk_configuration = \UpsProVendor\Symfony\Component\Yaml\Yaml::parseFile(\getcwd() . '/tests/codeception/wpdesk.yml');
        } catch (\UpsProVendor\Symfony\Component\Yaml\Exception\ParseException $e) {
            $wpdesk_configuration = array();
        }
        return \UpsProVendor\WPDesk\Composer\Codeception\Commands\Configuration::createFromEnvAndConfiguration($wpdesk_configuration);
    }
    /**
     * @param OutputInterface $output
     * @param Configuration   $configuration
     */
    private function prepareWpConfig(\UpsProVendor\Symfony\Component\Console\Output\OutputInterface $output, \UpsProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param Configuration   $configuration
     */
    private function activatePlugins(\UpsProVendor\Symfony\Component\Console\Output\OutputInterface $output, \UpsProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     */
    private function executeWpCliAndOutput($command, \UpsProVendor\Symfony\Component\Console\Output\OutputInterface $output, $apache_document_root)
    {
     ...
     * @param Configuration   $configuration
     */
    private function installPlugin($plugin_slug, \UpsProVendor\Symfony\Component\Console\Output\OutputInterface $output, \UpsProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @return string
     */
    private function prepareTargetDir($plugin_slug, \UpsProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param OutputInterface $output
     */
    private function prepareCommonWpWcConfiguration(\UpsProVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, \UpsProVendor\Symfony\Component\Console\Output\OutputInterface $output)
    {
