...
use UpsProVendor\Composer\Downloader\FilesystemException;
 ...
 */
class CreateCodeceptionTests extends \UpsProVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \UpsProVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
