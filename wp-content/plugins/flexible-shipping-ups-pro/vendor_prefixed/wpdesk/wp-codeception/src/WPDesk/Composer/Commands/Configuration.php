...
use UpsProVendor\Dotenv\Dotenv;
/**
 * Env.
 */
class Configuration
{
    ...
    {
        $dotenv = \UpsProVendor\Dotenv\Dotenv::createImmutable(\getcwd() . '/../');
        $dotenv->safeLoad();
        ...
        if (isset($configuration['plugin-slug'])) {
            ...
            throw new \UpsProVendor\WPDesk\Composer\Codeception\Commands\SettingsException('Missing plugin-slug setting!');
        }
        if (isset($configuration['plugin-file'])) {
            $plugin_file = $configuration['plugin-file'];
        } else {
            throw new \UpsProVendor\WPDesk\Composer\Codeception\Commands\SettingsException('Missing plugin-file setting!');
        }
        if (isset($configuration['plugin-title'])) {
            $plugin_title = $configuration['plugin-title'];
        } else {
            throw new \UpsProVendor\WPDesk\Composer\Codeception\Commands\SettingsException('Missing plugin-title setting!');
        }
