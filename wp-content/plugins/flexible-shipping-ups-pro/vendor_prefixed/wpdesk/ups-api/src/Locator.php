 ...
 */
class Locator extends \UpsProVendor\Ups\Ups
{
    private $request;
    ...
    public function getLocations(\UpsProVendor\Ups\Entity\LocatorRequest $request, $requestOption = self::OPTION_UPS_ACCESS_POINT_LOCATIONS)
    {
     ...
     * @return \stdClass
     */
    private function sendRequest(\UpsProVendor\Ups\Entity\LocatorRequest $request, $requestOption)
    {
     ...
     * @return string
     */
    private function createRequest(\UpsProVendor\Ups\Entity\LocatorRequest $locatorRequest, $requestOption)
    {
        $xml = new \DOMDocument();
