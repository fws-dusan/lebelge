...
use UpsProVendor\Ups\Entity\Tradeability\LandedCostRequest;
/**
 * Tradeability API Wrapper.
 *
 * @author Stefan Doorn <stefan@efectos.nl>
 */
class Tradeability extends \UpsProVendor\Ups\Ups
{
    /**
     *
     */
     ...
     * @throws Exception
     */
    public function getLandedCosts(\UpsProVendor\Ups\Entity\Tradeability\LandedCostRequest $request)
    {
     ...
     * @return string
     */
    private function createRequestLandedCost(\UpsProVendor\Ups\Entity\Tradeability\LandedCostRequest $landedCostRequest)
    {
        $xml = new \DOMDocument();
    ...
    public function getRequest()
    {
        if (null === $this->request) {
            $this->request = new \UpsProVendor\Ups\SoapRequest($this->logger);
        }
        return $this->request;
    }
    /**
