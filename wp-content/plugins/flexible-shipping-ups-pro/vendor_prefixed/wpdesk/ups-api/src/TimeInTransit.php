...
use UpsProVendor\Ups\Entity\TimeInTransitRequest;
use UpsProVendor\Ups\Entity\TimeInTransitResponse;
/**
 * TimeInTransit API Wrapper.
 *
 * @author Sebastien Vergnes <sebastien@vergnes.eu>
 */
class TimeInTransit extends \UpsProVendor\Ups\Ups
{
    private $request;
     ...
     */
    public function getTimeInTransit(\UpsProVendor\Ups\Entity\TimeInTransitRequest $shipment)
    {
     ...
     * @return TimeInTransitResponse
     */
    private function sendRequest(\UpsProVendor\Ups\Entity\TimeInTransitRequest $timeInTransitRequest)
    {
     ...
     * @return string
     */
    private function createRequest(\UpsProVendor\Ups\Entity\TimeInTransitRequest $timeInTransitRequest)
    {
        $xml = new \DOMDocument();
    ...
    private function formatResponse(\SimpleXMLElement $response)
    {
        ...
        return new \UpsProVendor\Ups\Entity\TimeInTransitResponse($result->TransitResponse);
    }
    /**
