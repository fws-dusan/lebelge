 ...
 */
class Rate extends \UpsProVendor\Ups\Ups
{
    const ENDPOINT = '/Rate';
    /**
     ...
     * @return RateResponse
     */
    protected function sendRequest(\UpsProVendor\Ups\Entity\RateRequest $rateRequest)
    {
     ...
     * @return string
     */
    private function createRequest(\UpsProVendor\Ups\Entity\RateRequest $rateRequest)
    {
        ...
        if ($pickupType instanceof \UpsProVendor\Ups\Entity\PickupType) {
    ...
    private function formatResponse(\SimpleXMLElement $response)
    {
        ...
        return new \UpsProVendor\Ups\Entity\RateResponse($result);
    }
    /**
