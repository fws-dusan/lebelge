...
use UpsProVendor\Ups\Entity\LabelRecoveryRequest;
use UpsProVendor\Ups\Entity\LabelRecoveryResponse;
/**
 * LabelRecovery API Wrapper.
 *
 * @author Sebastien Vergnes <sebastien@vergnes.eu>
 */
class LabelRecovery extends \UpsProVendor\Ups\Ups
{
    ...
    private function formatResponse(\SimpleXMLElement $response)
    {
        ...
        return new \UpsProVendor\Ups\Entity\LabelRecoveryResponse($result);
    }
}
