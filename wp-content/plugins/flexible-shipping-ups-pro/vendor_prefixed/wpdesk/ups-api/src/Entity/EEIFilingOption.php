...
class EEIFilingOption implements \UpsProVendor\Ups\NodeInterface
{
    const FO_SHIPPER = '1';
    // Shipper Filed
    const FO_UPS = '3';
    ...
    public function __construct($attributes = null)
    {
        if (null !== $attributes) {
            ...
            if (isset($attributes->UPSFiled)) {
                $this->setUPSFiled(new \UpsProVendor\Ups\Entity\UPSFiled($attributes->UPSFiled));
            }
            if (isset($attributes->ShipperFiled)) {
                $this->setShipperFiled(new \UpsProVendor\Ups\Entity\ShipperFiled($attributes->ShipperFiled));
            }
        }
    }
    /**
     ...
     * @return $this
     */
    public function setUPSFiled(\UpsProVendor\Ups\Entity\UPSFiled $upsFiled)
    {
     ...
     * @return $this
     */
    public function setShipperFiled(\UpsProVendor\Ups\Entity\ShipperFiled $shipperFiled)
    {
