...
class BillThirdParty
{
    ...
    {
        $this->thirdPartyAddress = new \UpsProVendor\Ups\Entity\Address(isset($attributes->Address) ? $attributes->Address : null);
     ...
     */
    public function setThirdPartyAddress(\UpsProVendor\Ups\Entity\Address $thirdPartyAddress = null)
    {
