...
class ShipmentServiceOptions implements \UpsProVendor\Ups\NodeInterface
{
    /**
     * @var
     */
    ...
    {
        $this->CallTagARS = new \UpsProVendor\Ups\Entity\CallTagARS();
        if (null !== $response) {
            ...
            if (isset($response->AccessPointCOD)) {
                $this->setAccessPointCOD(new \UpsProVendor\Ups\Entity\AccessPointCOD($response->AccessPointCOD));
            }
            if (isset($response->CallTagARS)) {
                $this->CallTagARS = new \UpsProVendor\Ups\Entity\CallTagARS($response->CallTagARS);
            }
            ...
            if (isset($response->LabelMethod)) {
                $this->setLabelMethod(new \UpsProVendor\Ups\Entity\LabelMethod($response->LabelMethod));
            }
            if (isset($response->EMailMessage)) {
                $this->setEMailMessage(new \UpsProVendor\Ups\Entity\EMailMessage($response->EMailMessage));
            }
        }
    }
    /**
     ...
     * @return $this
     */
    public function setInternationalForms(\UpsProVendor\Ups\Entity\InternationalForms $data)
    {
     ...
     * @return $this
     */
    public function setLabelMethod(\UpsProVendor\Ups\Entity\LabelMethod $data)
    {
     ...
     * @return $this
     */
    public function setLabelDelivery(\UpsProVendor\Ups\Entity\LabelDelivery $data)
    {
     ...
     * @return $this
     */
    public function addNotification(\UpsProVendor\Ups\Entity\Notification $notification)
    {
     ...
     * @return ShipmentServiceOptions
     */
    public function setDeliveryConfirmation(\UpsProVendor\Ups\Entity\DeliveryConfirmation $deliveryConfirmation)
    {
