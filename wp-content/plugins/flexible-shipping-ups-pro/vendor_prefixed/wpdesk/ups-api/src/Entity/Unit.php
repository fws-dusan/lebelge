 ...
 * Class Unit.
 */
class Unit implements \UpsProVendor\Ups\NodeInterface
{
    /**
     * @var string
     */
    ...
    public function __construct($attributes = null)
    {
        if (null !== $attributes) {
            ...
            if (isset($attributes->UnitOfMeasurement)) {
                $this->setUnitOfMeasurement(new \UpsProVendor\Ups\Entity\UnitOfMeasurement($attributes->UnitOfMeasurement));
            }
        }
    }
    /**
     ...
     * @return $this
     */
    public function setUnitOfMeasurement(\UpsProVendor\Ups\Entity\UnitOfMeasurement $unit)
    {
