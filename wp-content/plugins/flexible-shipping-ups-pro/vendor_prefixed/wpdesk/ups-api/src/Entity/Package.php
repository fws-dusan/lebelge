...
class Package implements \UpsProVendor\Ups\NodeInterface
{
    ...
    {
        $this->setPackagingType(new \UpsProVendor\Ups\Entity\PackagingType(isset($attributes->PackagingType) ? $attributes->PackagingType : null));
        $this->setReferenceNumber(new \UpsProVendor\Ups\Entity\ReferenceNumber());
        $this->setReferenceNumber2(new \UpsProVendor\Ups\Entity\ReferenceNumber());
        $this->setPackageWeight(new \UpsProVendor\Ups\Entity\PackageWeight());
        $this->setPackageServiceOptions(new \UpsProVendor\Ups\Entity\PackageServiceOptions());
        if (null !== $attributes) {
            if (isset($attributes->PackageWeight)) {
                $this->setPackageWeight(new \UpsProVendor\Ups\Entity\PackageWeight($attributes->PackageWeight));
            }
            if (isset($attributes->Description)) {
                $this->setDescription($attributes->Description);
            }
            if (isset($attributes->PackageServiceOptions)) {
                $this->setPackageServiceOptions(new \UpsProVendor\Ups\Entity\PackageServiceOptions($attributes->PackageServiceOptions));
            }
            ...
            if (isset($attributes->ReferenceNumber)) {
                $this->setReferenceNumber(new \UpsProVendor\Ups\Entity\ReferenceNumber($attributes->ReferenceNumber));
            }
            if (isset($attributes->ReferenceNumber2)) {
                $this->setReferenceNumber2(new \UpsProVendor\Ups\Entity\ReferenceNumber($attributes->ReferenceNumber2));
            }
            ...
            if (isset($attributes->Dimensions)) {
                $this->setDimensions(new \UpsProVendor\Ups\Entity\Dimensions($attributes->Dimensions));
            }
            if (isset($attributes->Activity)) {
                $activities = $this->getActivities();
                if (\is_array($attributes->Activity)) {
                    foreach ($attributes->Activity as $Activity) {
                        $activities[] = new \UpsProVendor\Ups\Entity\Activity($Activity);
                    }
                } else {
                    $activities[] = new \UpsProVendor\Ups\Entity\Activity($attributes->Activity);
                }
     ...
     * @return Package
     */
    public function setDimensions(\UpsProVendor\Ups\Entity\Dimensions $dimensions)
    {
     ...
     * @return Package
     */
    public function setPackageServiceOptions(\UpsProVendor\Ups\Entity\PackageServiceOptions $packageServiceOptions)
    {
     ...
     * @return Package
     */
    public function setPackageWeight(\UpsProVendor\Ups\Entity\PackageWeight $packageWeight)
    {
     ...
     * @return Package
     */
    public function setPackagingType(\UpsProVendor\Ups\Entity\PackagingType $packagingType)
    {
