...
class ItemizedPaymentInformation
{
     ...
     */
    public function setShipmentCharge(\UpsProVendor\Ups\Entity\ShipmentCharge $shipmentCharge)
    {
        if ($shipmentCharge->getType() === \UpsProVendor\Ups\Entity\ShipmentCharge::SHIPMENT_CHARGE_TYPE_TRANSPORTATION) {
            $this->transportationShipmentCharge = $shipmentCharge;
        } elseif ($shipmentCharge->getType() === \UpsProVendor\Ups\Entity\ShipmentCharge::SHIPMENT_CHARGE_TYPE_DUTIES) {
