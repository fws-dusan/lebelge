...
class Shipper implements \UpsProVendor\Ups\NodeInterface
{
    /**
     * @var string
     */
    ...
    {
        $this->address = new \UpsProVendor\Ups\Entity\Address();
        if (null !== $attributes) {
            ...
            if (isset($attributes->Address)) {
                $this->setAddress(new \UpsProVendor\Ups\Entity\Address($attributes->Address));
            }
        }
    }
    /**
     ...
     * @return Shipper
     */
    public function setAddress(\UpsProVendor\Ups\Entity\Address $address)
    {
