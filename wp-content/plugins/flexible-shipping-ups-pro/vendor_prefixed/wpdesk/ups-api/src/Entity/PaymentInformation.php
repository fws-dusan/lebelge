...
class PaymentInformation
{
    ...
    public function __construct($type = self::TYPE_PREPAID, $attributes = null)
    {
        switch ($type) {
            case self::TYPE_PREPAID:
                $this->prepaid = new \UpsProVendor\Ups\Entity\Prepaid($attributes);
                break;
            case self::TYPE_BILL_THIRD_PARTY:
                $this->billThirdParty = new \UpsProVendor\Ups\Entity\BillThirdParty($attributes);
                break;
            case self::TYPE_FREIGHT_COLLECT:
                $this->freightCollect = new \UpsProVendor\Ups\Entity\FreightCollect($attributes);
                break;
     ...
     */
    public function setPrepaid(\UpsProVendor\Ups\Entity\Prepaid $prepaid = null)
    {
     ...
     * @return PaymentInformation
     */
    public function setBillThirdParty(\UpsProVendor\Ups\Entity\BillThirdParty $billThirdParty = null)
    {
     ...
     * @return PaymentInformation
     */
    public function setFreightCollect(\UpsProVendor\Ups\Entity\FreightCollect $freightCollect = null)
    {
