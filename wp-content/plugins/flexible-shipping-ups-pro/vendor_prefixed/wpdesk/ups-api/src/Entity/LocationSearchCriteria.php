...
class LocationSearchCriteria implements \UpsProVendor\Ups\NodeInterface
{
    /**
     ...
     */
    public function setAccessPointSearch(\UpsProVendor\Ups\Entity\AccessPointSearch $accessPointSearch)
    {
