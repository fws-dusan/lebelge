...
namespace UpsProVendor\Ups\Entity\AddressValidation;
...
class AVAddress
{
    ...
    public function __construct(\SimpleXMLElement $xmlDoc)
    {
        ...
        $this->addressClassification = isset($xmlDoc->AddressClassification) ? new \UpsProVendor\Ups\Entity\AddressValidation\AddressClassification($xmlDoc->AddressClassification) : null;
