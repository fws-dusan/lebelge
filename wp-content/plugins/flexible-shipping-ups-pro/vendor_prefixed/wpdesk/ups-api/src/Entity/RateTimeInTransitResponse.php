...
use UpsProVendor\Ups\Entity\RateTimeInTransit\ServiceSummary as RateTimeInTransitServiceSummary;
    ...
    public function __construct(\stdClass $response = null)
    {
        ...
        if (null !== $response) {
            ...
            if (isset($response->ServiceSummary)) {
                $this->ServiceSummary = new \UpsProVendor\Ups\Entity\RateTimeInTransit\ServiceSummary($response->ServiceSummary);
            }
        }
    }
}
