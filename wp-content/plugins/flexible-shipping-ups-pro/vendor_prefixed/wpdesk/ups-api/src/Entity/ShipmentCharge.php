...
class ShipmentCharge
{
     ...
     */
    public function setBillShipper(\UpsProVendor\Ups\Entity\BillShipper $billShipper)
    {
     ...
     * @return ShipmentCharge
     */
    public function setBillReceiver(\UpsProVendor\Ups\Entity\BillReceiver $billReceiver = null)
    {
