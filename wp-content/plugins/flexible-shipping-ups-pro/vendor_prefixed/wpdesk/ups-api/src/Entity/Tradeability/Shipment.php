...
class Shipment implements \UpsProVendor\Ups\NodeInterface
{
    ...
    public function toNode(\UpsProVendor\DomDocument $document = null)
    {
        ...
        if ($this->getFreightCharges() instanceof \UpsProVendor\Ups\Entity\Tradeability\FreightCharges) {
     ...
     * @return $this
     */
    public function addProduct(\UpsProVendor\Ups\Entity\Tradeability\Product $product)
    {
