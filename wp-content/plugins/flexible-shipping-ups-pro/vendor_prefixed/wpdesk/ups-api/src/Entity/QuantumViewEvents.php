        ...
        if (isset($response->SubscriptionEvents)) {
            if (\is_array($response->SubscriptionEvents)) {
                foreach ($response->SubscriptionEvents as $SubscriptionEvents) {
                    $this->SubscriptionEvents[] = new \UpsProVendor\Ups\Entity\SubscriptionEvents($SubscriptionEvents);
                }
            } else {
                $this->SubscriptionEvents[] = new \UpsProVendor\Ups\Entity\SubscriptionEvents($response->SubscriptionEvents);
            }
        }
    }
}
