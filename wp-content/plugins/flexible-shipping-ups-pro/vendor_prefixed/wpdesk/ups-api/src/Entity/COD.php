...
class COD implements \UpsProVendor\Ups\NodeInterface
{
    /**
     * @var string
     */
    ...
    {
        $this->CODAmount = new \UpsProVendor\Ups\Entity\CODAmount();
        if (null !== $response) {
            ...
            if (isset($response->CODAmount)) {
                $this->CODAmount = new \UpsProVendor\Ups\Entity\CODAmount($response->CODAmount);
            }
        }
    }
    /**
     ...
     * @return COD
     */
    public function setCODAmount(\UpsProVendor\Ups\Entity\CODAmount $CODAmount)
    {
