...
class PackageWeight implements \UpsProVendor\Ups\NodeInterface
{
    /** @deprecated */
    ...
    {
        $this->setUnitOfMeasurement(new \UpsProVendor\Ups\Entity\UnitOfMeasurement(isset($attributes->UnitOfMeasurement) ? $attributes->UnitOfMeasurement : null));
