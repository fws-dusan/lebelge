...
class Dimensions implements \UpsProVendor\Ups\NodeInterface
{
    /**
     * @var int
     */
    ...
    {
        $this->setUnitOfMeasurement(new \UpsProVendor\Ups\Entity\UnitOfMeasurement(isset($response->UnitOfMeasurement) ? $response->UnitOfMeasurement : null));
        if (null !== $response) {
