 ...
 * @package Ups\Entity
 */
class PackageServiceOptions implements \UpsProVendor\Ups\NodeInterface
{
    /**
     * @var COD
     */
    ...
    public function __construct($parameters = null)
    {
        if (null !== $parameters) {
            if (isset($parameters->COD)) {
                $this->setCOD(new \UpsProVendor\Ups\Entity\COD($parameters->COD));
            }
            if (isset($parameters->InsuredValue)) {
                $this->setInsuredValue(new \UpsProVendor\Ups\Entity\InsuredValue($parameters->InsuredValue));
            }
     ...
     * @param HazMat $hazmat
     */
    public function addHazMat(\UpsProVendor\Ups\Entity\HazMat $hazmat)
    {
        $this->hazMat[] = $hazmat;
    }
    /**
