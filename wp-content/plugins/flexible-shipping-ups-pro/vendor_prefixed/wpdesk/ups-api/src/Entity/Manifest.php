...
class Manifest
{
    ...
    {
        $this->Shipper = new \UpsProVendor\Ups\Entity\Shipper();
        $this->ReferenceNumber = new \UpsProVendor\Ups\Entity\ReferenceNumber();
        $this->Service = new \UpsProVendor\Ups\Entity\Service();
        $this->ShipmentServiceOptions = new \UpsProVendor\Ups\Entity\ShipmentServiceOptions();
        $this->CustomsValue = new \UpsProVendor\Ups\Entity\CustomsValue();
        $this->BillToAccount = new \UpsProVendor\Ups\Entity\BillToAccount();
        $this->UAPAddress = new \UpsProVendor\Ups\Entity\Address();
        if (null !== $response) {
            if (isset($response->Shipper)) {
                $this->Shipper = new \UpsProVendor\Ups\Entity\Shipper($response->Shipper);
            }
            ...
            if (isset($response->ReferenceNumber)) {
                if (\is_array($response->ReferenceNumber)) {
                    foreach ($response->ReferenceNumber as $ReferenceNumber) {
                        $this->ReferenceNumber[] = new \UpsProVendor\Ups\Entity\ReferenceNumber($ReferenceNumber);
                    }
                } else {
                    $this->ReferenceNumber[] = new \UpsProVendor\Ups\Entity\ReferenceNumber($response->ReferenceNumber);
                }
            }
            if (isset($response->Service)) {
                $this->Service = new \UpsProVendor\Ups\Entity\Service($response->Service);
            }
            ...
            if (isset($response->Package)) {
                if (\is_array($response->Package)) {
                    foreach ($response->Package as $Package) {
                        $this->Package[] = new \UpsProVendor\Ups\Entity\Package($Package);
                    }
                } else {
                    $this->Package[] = new \UpsProVendor\Ups\Entity\Package($response->Package);
                }
            }
            if (isset($response->ShipmentServiceOptions)) {
                $this->ShipmentServiceOptions = new \UpsProVendor\Ups\Entity\ShipmentServiceOptions($response->ShipmentServiceOptions);
            }
            ...
            if (isset($response->CustomsValue)) {
                $this->CustomsValue = new \UpsProVendor\Ups\Entity\CustomsValue($response->CustomsValue);
            }
            ...
            if (isset($response->UAPAddress)) {
                $this->UAPAddress = new \UpsProVendor\Ups\Entity\Address($response->UAPAddress);
            }
        }
    }
}
