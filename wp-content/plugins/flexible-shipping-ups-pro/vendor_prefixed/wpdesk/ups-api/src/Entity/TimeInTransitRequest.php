...
class TimeInTransitRequest
{
    ...
    {
        $this->setTransitFrom(new \UpsProVendor\Ups\Entity\AddressArtifactFormat());
        $this->setTransitTo(new \UpsProVendor\Ups\Entity\AddressArtifactFormat());
        $this->setShipmentWeight(new \UpsProVendor\Ups\Entity\ShipmentWeight());
        $this->setInvoiceLineTotal(new \UpsProVendor\Ups\Entity\InvoiceLineTotal());
     ...
     */
    public function setTransitFrom(\UpsProVendor\Ups\Entity\AddressArtifactFormat $address)
    {
     ...
     * @param AddressArtifactFormat $address
     */
    public function setTransitTo(\UpsProVendor\Ups\Entity\AddressArtifactFormat $address)
    {
     ...
     */
    public function setShipmentWeight(\UpsProVendor\Ups\Entity\ShipmentWeight $shipmentWeight)
    {
