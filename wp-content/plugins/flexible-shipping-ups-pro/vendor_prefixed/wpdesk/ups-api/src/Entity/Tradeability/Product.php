 ...
 * Class Product.
 */
class Product implements \UpsProVendor\Ups\NodeInterface
{
    /**
     * @var string
     */
    ...
    public function toNode(\DOMDocument $document = null)
    {
        ...
        if ($this->getWeight() instanceof \UpsProVendor\Ups\Entity\Tradeability\Weight) {
     ...
     * @return Product
     */
    public function setTariffInfo(\UpsProVendor\Ups\Entity\Tradeability\TariffInfo $tariffInfo)
    {
