...
class FreightCollect
{
    ...
    public function __construct(\stdClass $attributes = null)
    {
        ...
        if (isset($attributes->BillReceiverAddress)) {
            $this->setBillReceiverAddress(new \UpsProVendor\Ups\Entity\Address($attributes->BillReceiverAddress));
        }
    }
    /**
     * @return string
     ...
     * @return FreightCollect
     */
    public function setBillReceiverAddress(\UpsProVendor\Ups\Entity\Address $address = null)
    {
