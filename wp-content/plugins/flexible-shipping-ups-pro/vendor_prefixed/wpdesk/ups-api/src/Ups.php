...
use stdClass;
abstract class Ups implements \Psr\Log\LoggerAwareInterface
{
     ...
     */
    public function __construct($accessKey = null, $userId = null, $password = null, $useIntegration = \false, \Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        $requestInstance = new \UpsProVendor\Ups\Request($this->logger);
