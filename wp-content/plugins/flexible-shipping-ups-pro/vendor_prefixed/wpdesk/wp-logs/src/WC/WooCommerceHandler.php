...
use UpsProVendor\Monolog\Handler\AbstractProcessingHandler;
use UpsProVendor\Monolog\Logger;
/**
 * Class WooCommerceFactory
 */
class WooCommerceHandler extends \UpsProVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \UpsProVendor\Monolog\Logger::getLevelName($level);
    }
