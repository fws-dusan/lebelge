 ...
 */
class SlackbotHandler extends \UpsProVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \UpsProVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
