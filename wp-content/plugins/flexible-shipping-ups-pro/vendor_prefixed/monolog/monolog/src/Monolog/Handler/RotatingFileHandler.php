 ...
 */
class RotatingFileHandler extends \UpsProVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \UpsProVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \UpsProVendor\Monolog\Utils::canonicalizePath($filename);
