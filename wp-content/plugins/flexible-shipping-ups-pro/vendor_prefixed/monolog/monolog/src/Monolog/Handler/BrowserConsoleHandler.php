 ...
 */
class BrowserConsoleHandler extends \UpsProVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \UpsProVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
