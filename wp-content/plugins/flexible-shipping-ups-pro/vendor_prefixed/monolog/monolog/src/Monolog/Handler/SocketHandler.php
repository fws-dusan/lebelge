 ...
 */
class SocketHandler extends \UpsProVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \UpsProVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
