...
if ( ! class_exists( 'IC_Commerce_Ultimate_Woocommerce_Report_Settings' ) ) {
	/*
	 * Class Name IC_Commerce_Ultimate_Woocommerce_Report_Settings
	 *
	 * Class is used for Report Plugin Settings.
	 *	 
	*/
	class IC_Commerce_Ultimate_Woocommerce_Report_Settings extends IC_Commerce_Ultimate_Woocommerce_Report_Functions{
		...
		*/
		public function __construct($constants) {
			...
			$this->constants['projected_month_list'] = array(__('January','icwoocommerce_textdomains'),__('February','icwoocommerce_textdomains'),__('March','icwoocommerce_textdomains'),__('April','icwoocommerce_textdomains'),__('May','icwoocommerce_textdomains'),__('June','icwoocommerce_textdomains'),__('July','icwoocommerce_textdomains'),__('August','icwoocommerce_textdomains'),__('September','icwoocommerce_textdomains'),__('October','icwoocommerce_textdomains'),__('November','icwoocommerce_textdomains'),__('December','icwoocommerce_textdomains'),__('January','icwoocommerce_textdomains'),__('February','icwoocommerce_textdomains'),__('March','icwoocommerce_textdomains'),__('April','icwoocommerce_textdomains'),__('May','icwoocommerce_textdomains'),__('June','icwoocommerce_textdomains'),__('July','icwoocommerce_textdomains'),__('August','icwoocommerce_textdomains'),__('September','icwoocommerce_textdomains'),__('October','icwoocommerce_textdomains'),__('November','icwoocommerce_textdomains'),__('December','icwoocommerce_textdomains'),__('January','icwoocommerce_textdomains'),__('February','icwoocommerce_textdomains'),__('March','icwoocommerce_textdomains'),__('April','icwoocommerce_textdomains'),__('May','icwoocommerce_textdomains'),__('June','icwoocommerce_textdomains'),__('July','icwoocommerce_textdomains'),__('August','icwoocommerce_textdomains'),__('September','icwoocommerce_textdomains'),__('October','icwoocommerce_textdomains'),__('November','icwoocommerce_textdomains'),__('December','icwoocommerce_textdomains'));
		...
		*/
			...
			?>
                <form method="post" id="form_ic_commerce_settings" name="form_ic_commerce_settings" class="form_ic_commerce_settings force_submit" autocomplete="off">
                    ...
                    <?php
						...
						do_action('ic_commerce_report_setting_page_top',$this->constants,$this);
						do_settings_sections( $this->constants['plugin_key'] );
						do_action('ic_commerce_report_setting_page_bottom',$this->constants,$this);
					?>
                    	<br />
		...
		/**
		* save_settings
		* This function is used for Save Setting of Report Plugin.
		*/
		function save_settings(){
			...
			if(isset($_POST[$option]) and (isset($_POST['option_page']) and $_POST['option_page'] == $option) and  isset($_POST['option_page'])){
				...
				$post['tr_remove_country_join'] = isset($post['tr_remove_country_join']) ? $post['tr_remove_country_join'] : 'no';
				$post['tr_remove_state_join'] = isset($post['tr_remove_state_join']) ? $post['tr_remove_state_join'] : 'no';
				
				if($post['tr_remove_state_join'] == 'yes'){
					$post['tr_remove_country_join']= 'yes';
				}
				...
				if(strlen($ga_account)>0 || strlen($ga_password)>0){
					include_once("ic_commerce_ultimate_report_gapi.class.php");
				...
				$post = apply_filters("ic_commerce_ultimate_report_settting_values", $post, $this, $o);
				$post = apply_filters("ic_commerce_ultimate_report_setting_values", $post, $this, $o);
		...
		*/
		public function init_settings() {
			...
			*/
			...
			//apply_filters( 'woocommerce_reports_order_statuses', array( 'completed', 'processing', 'on-hold' ) ) ) 
			...
			add_settings_field('show_sections',			__( 'Enable Sections:', 'icwoocommerce_textdomains'),		array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_sections','id'=> 'show_sections','default'=>0));
			
			add_settings_field('show_graph',			__( 'Show Graphical Presentation:', 'icwoocommerce_textdomains'),		array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_graph','id'=> 'show_graph','default'=>0));
			
			add_settings_field('show_monthly_summary',			__( 'Show Monthly Summary:', 'icwoocommerce_textdomains'),		array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_monthly_summary','id'=> 'show_monthly_summary','default'=>0));
			
			add_settings_field('show_map',			__( 'Show Map:', 'icwoocommerce_textdomains'),		array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_map','id'=> 'show_map','default'=>0));
			
			add_settings_field('show_order_summary',			__( 'Show Order Summary:', 'icwoocommerce_textdomains'),		array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_order_summary','id'=> 'show_order_summary','default'=>0));
			
			add_settings_field('show_sales_order_status',		__( 'Show Sales Order Status:', 'icwoocommerce_textdomains'),	array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_sales_order_status','id'=> 'show_sales_order_status','default'=>0));
			
			add_settings_field('show_top_products',			__( 'Show Top Products:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_top_products','id'=> 'show_top_products','default'=>0));
			
			add_settings_field('show_top_categories',			__( 'Show Top Categories:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_top_categories','id'=> 'show_top_categories','default'=>0));
			
			add_settings_field('show_top_countries',			__( 'Show Top Countries:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_top_countries','id'=> 'show_top_countries','default'=>0));
			
			add_settings_field('show_top_states',			__( 'Show Top States:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_top_states','id'=> 'show_top_states','default'=>0));
			
			add_settings_field('show_recent_orders',			__( 'Show Recent Orders:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_recent_orders','id'=> 'show_recent_orders','default'=>0));
						
			add_settings_field('show_top_customers',			__( 'Show Top Customers:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_top_customers','id'=> 'show_top_customers','default'=>0));
			...
			add_settings_field('show_monthly_profit_center',	__( 'Show Monthly Profit Center:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_monthly_profit_center','id'=> 'show_monthly_profit_center','default'=>0));
			
			add_settings_field('show_top_profit_products',			__( 'Show Top Profit Products:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ),$option, 'dashboard_sections', array('menu'=> $option,	'value'=>'1',	'label_for'=>'show_top_profit_products','id'=> 'show_top_profit_products','default'=>0));
			...
			do_action('ic_commerce_ultimate_report_settting_field_after_dashboard',$this, $option);
			...
			do_action('ic_commerce_ultimate_report_settting_field_after_default_setting',$this, $option);
			...
			add_settings_section('tax_report',					__(	'Tax Reports:', 'icwoocommerce_textdomains'),			array( &$this, 'section_options_callback' ),$option);
			add_settings_field('tr_remove_country_join',		__( 'Remove Country Join:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ), $option, 'tax_report', array('menu'=> $option,'label_for'=>'tr_remove_country_join','id'=> 'tr_remove_country_join','default'=>'yes','value'=>'yes'));
			//add_settings_field('tr_remove_state_join',			__( 'Remove State:', 'icwoocommerce_textdomains'),			array( &$this,'checkbox_element_callback' ), $option, 'tax_report', array('menu'=> $option,'label_for'=>'tr_remove_state_join','id'=> 'tr_remove_state_join','default'=>'yes','value'=>'yes'));
			...
			do_action('ic_commerce_ultimate_report_settting_field_after_email_report',$this, $option);
			...
			add_settings_field('pdf_invoice_name_logo_align',	__( 'Company Name and Logo Align:', 'icwoocommerce_textdomains'),		array( &$this, 'select_element_callback' ), 	$option, 'pdf_invoice_setting', array('menu'=> $option,	'label_for'=>'pdf_invoice_name_logo_align',		'id'=> 'pdf_invoice_name_logo_align','default'=>'company_name_left_left','options'=>array(
				//'0'=>"Select any one",
				'company_name_left_left'=>__("Company Name Left and Logo Left",'icwoocommerce_textdomains')
			)));
			...
			*/
			...
			do_action('ic_commerce_ultimate_report_settting_field_after_google_analytics',$this, $option);
		...
		/**
		 * multiple_select_element_callback
		...
		/**
		 * create_button_element_callback 
		 * @param string $args
		 */
		...
		/**
		 * check_email 
		 * This Function is used for Validate Email Field.
		 * @param string $check
		 * @return string
		 */
		...
		/**
		 * get_default_cogs_key 
		 * @param string $post
		 * @param string $post_key
		 * @param string $cog_defaulty_key
		 * @return string
		 */
