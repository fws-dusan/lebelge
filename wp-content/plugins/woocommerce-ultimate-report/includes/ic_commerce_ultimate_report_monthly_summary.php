...
if ( ! class_exists( 'IC_Commerce_Ultimate_Woocommerce_Report_Monthly_Summary' ) ) {
	/*
	 * Class Name IC_Commerce_Ultimate_Woocommerce_Report_Monthly_Summary
	 *
	 * Class is used for Monthly Report Summary
	 *	 
	*/
	class IC_Commerce_Ultimate_Woocommerce_Report_Monthly_Summary extends IC_Commerce_Ultimate_Woocommerce_Report_Functions{
		...
		*/
		...
		/**
		* get_grid
		* This Function is used for Display Data in Grid.
		* @return string
		*/
		function get_grid(){
			global $plugin_options;
		...
		/**
		* get_detail_grid
		* This Function is used for Display Detail Data in Grid.
		* @return string
		*/
		...
		*/
		...
		/**
		* get_detail_columns
		* This Function is used to get Details Columns.
		* @return array
		*/
		...
		* @param integer $cur_projected_sales_year
		* @return array
		*/
		function get_items($shop_order_status, $hide_order_status, $start_date, $end_date, $month_count = 12, $cur_projected_sales_year = 2010){
			...
			foreach ($month_list as $key => $value) {				
				$projected_sales_month				= isset($months[$m]) ? $months[$m] : $months[11];
			...
			$new_data2[$i]["month_name"] 				=	__("Total",'icwoocommerce_textdomains');
		...
		* This Function is used to get Total Sales By Month.
		* @param string $shop_order_status
		* @param string $hide_order_status
		* @param string $start_date
		* @param string $end_date
		* @param string $meta_key
		* @param string $meta_key2
		* @return array
		*/
		function get_total_sales_by_month($shop_order_status, $hide_order_status, $start_date, $end_date, $meta_key = "_order_discount", $meta_key2 = NULL){
			...
			if($meta_key2){
				$sql .= " LEFT JOIN  {$wpdb->postmeta} as postmeta2 ON posts.ID=postmeta2.post_id";
			}
		...
		/**
		* get_total_status_sales_by_month
		* This Function is used to get Total Status By Month.
		* @param string $shop_order_status
		* @param string $hide_order_status
		* @param string $start_date
		* @param string $end_date
		* @param string $month_count
		* @param string $meta_key
		* @return array
		*/
		...
		/**
		* get_part_order_refunded_amount_by_month
		* This Function is used to get Part Order Refunded Amount By Month.
		* @param string $shop_order_status
		* @param string $hide_order_status
		* @param string $start_date
		* @param string $end_date
