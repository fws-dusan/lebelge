...
if ( ! class_exists( 'IC_Commerce_Ultimate_Woocommerce_Report_Columns' ) ) {
	/*
	 * Class Name IC_Commerce_Ultimate_Woocommerce_Report_Columns
	 *
	 * Class is used for WooCommerce Report Columns
	 *	 
	*/
	class IC_Commerce_Ultimate_Woocommerce_Report_Columns{
		...
		*/
		...
		/**
		* get_dasbboard_coumns
		*
		* Get all report columns by report name
		*
			...
			if($report_name == "recent_order"){
				if($this->constants['post_order_status_found'] == 0 ){
					$columns 	= array(
						...
						,"transaction_id"								=> __("Transaction ID",			'icwoocommerce_textdomains')
						...
						,"total_discount"							=> __("Discount Amt.", 	'icwoocommerce_textdomains')
		...
		*
		* Get all variation report columns
		*
		* @param string $show_variation 
		* @param array $attributes 
		* @param integer $variation_column 
		*
		*
		* @return array
		*/
		...
		*/
		...
		/**
		* result_columns_details_page
		*
		* Get details page columns
		*
		...
		function result_columns_details_page($detail_column = 'no'){
			...
			if($detail_column == "yes"){
				$columns = array(
					...
					,"line_tax"									=> __("Item Tax",					'icwoocommerce_textdomains')
					,"total_price"								=> __("Net Amt."	, 				'icwoocommerce_textdomains')
				);
			}else{				
				$columns = array(
					"total_row_count"							=> __("Order Count", 				'icwoocommerce_textdomains')
					//,"paypal_transaction_fee"				  => __("PayPal Transaction Fee", 			'icwoocommerce_textdomains')
					,"gross_amount"								=> __("Gross Amt.", 				'icwoocommerce_textdomains')					
			...
			if($detail_column == "details_view"){
				...
				if($this->constants['post_order_status_found'] == 0 ){
					...
					$columns = array(					
						...
						//,"payment_type"							=> __("Payment Type", 			'icwoocommerce_textdomains')
						,"order_currency"							=> __("Order Currency", 				'icwoocommerce_textdomains')
						,"order_coupon_codes"						=> __("Coupon Code", 					'icwoocommerce_textdomains')
						,"order_item_count"							=> __("Items", 							'icwoocommerce_textdomains')
						//,"paypal_transaction_fee"				  => __("PayPal Transaction Fee", 			'icwoocommerce_textdomains')
		...
		*/
		...
		/**
		* grid_columns_all_reports
		*
		* Get report columns by report name
		*
		* @param string $report_name 
	    *
		*
			...
			switch ($report_name ) {
				...
				case "customer_page":
					$columns 	= array(
						...
						,"billing_company"		=> __("Company Name", 			'icwoocommerce_textdomains')
				...
				case "billing_country_page":
					...
					if(isset($columns['billing_country_name'])) 		$columns['billing_country_name'] 	= $billing_or_shipping == "shipping" ? __( 'Shipping Country' , 'icwoocommerce_textdomains') : $columns['billing_country_name'];
	...
	}//END class IC_Commerce_Ultimate_Woocommerce_Report_Columns{
}//END if ( ! class_exists( 'IC_Commerce_Ultimate_Woocommerce_Report_Columns' ) ) {