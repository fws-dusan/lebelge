...
if ( ! class_exists( 'IC_Commerce_Ultimate_Woocommerce_Report_Custom_fields' ) ) {
	class IC_Commerce_Ultimate_Woocommerce_Report_Custom_fields{
		...
		/*Declare order_fee variable*/
		public $order_fee	= 	array();
		
		/*Declare service_fee variable*/
		...
		*/
		...
		/**
		* woocommerce_order_ic_commerce_fields_delete
		*
		...
		*/
		function woocommerce_order_ic_commerce_fields_delete($item_id, $item, $order_id){
			global $wpdb;
			$wpdb->query("DELETE FROM {$wpdb->postmeta} WHERE meta_key LIKE '_ic_commerce_%' AND post_id={$order_id}");
		}
		/**
		...
		*/
		...
		/**
		* woocommerce_order_ic_commerce_fields_add
		*
		*
		* @param integer $order_id 
		*
